...
> **Architecture Pivot**: These blueprints will be developed in the remote `AI-Tadpole-OS-Industry-Templates` repository, not baked into the core Tadpole OS engine.
