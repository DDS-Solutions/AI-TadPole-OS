...
- **Subsystem**: Infrastructure Automation / test_runner
- **Primary Entrypoints**: `TestFrameworkInfo`, `detect_test_framework`, `RunTestResult`, `run_tests`
...
- **Local Errors**: none
- **Telemetry Targets**: `[PASS]`, `[FAIL]`, `[:200]`
