...
- **Subsystem**: Infrastructure Automation / api_validator
- **Primary Entrypoints**: `find_api_files`, `AuditResult`, `check_openapi_spec`, `check_api_code`
...
- **Local Errors**: none
- **Telemetry Targets**: `[FILE]`, `[RESULTS]`, `[OK]`, `[X]`
