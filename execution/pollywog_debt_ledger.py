...
EXCLUDE_DIRS = {".git", "node_modules", ".tmp", "dist", "target", "coverage", ".fallow", ".gemini"}
...
def scan_files(root_dir):
    ...
    for dirpath, dirnames, filenames in os.walk(root_dir):
        ...
        for filename in filenames:
            # Skip build/binary/lock files
            if filename.endswith((".png", ".jpg", ".jpeg", ".gif", ".ico", ".pdf", ".zip", ".tar.gz", "package-lock.json", "Cargo.lock", ".log")):
                continue
