...
- **Subsystem**: Infrastructure Automation / generate_startup_report
- **Primary Entrypoints**: `fetch_json`, `get_db_path`, `get_db_status`, `get_mission_data`
...
- **Local Errors**: none
- **Telemetry Targets**: `[generate_startup_report]`
...
def get_version_info():
    ...
    if vfile.exists():
        try:
            ...
            pass
    return {"version": "unknown", "name": "Tadpole OS", "codename": "Sovereign-Sentinel"}
...
> **OS Core Version**: `{version_data.get('name', 'Tadpole OS')} v{version_data.get('version', 'unknown')} ({version_data.get('codename', 'Sovereign-Sentinel')})`
