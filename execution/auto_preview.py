...
- **Subsystem**: Infrastructure Automation / auto_preview
- **Primary Entrypoints**: `get_project_root`, `is_running`, `get_start_command`, `start_server`
...
- **Local Errors**: none
- **Telemetry Targets**: `[WARN]`, `[FAIL]`, `[OK]`, `[SESSION-STATUS]`
...
Usage:
    python execution/auto_preview.py start [port]
    python execution/auto_preview.py stop
    python execution/auto_preview.py status
"""
import os
import sys
import time
