...
- **Subsystem**: Infrastructure Automation / session_manager
- **Primary Entrypoints**: `get_project_root`, `analyze_package_json`, `count_files`, `detect_features`
...
- **Local Errors**: none
- **Telemetry Targets**: `[SESSION-STATUS]`, `[OK]`
