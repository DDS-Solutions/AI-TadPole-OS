...
- **Subsystem**: Infrastructure Automation / seed_db
- **Primary Entrypoints**: `seed_database`
...
- **Local Errors**: none
- **Telemetry Targets**: `[seed_db]`, `[FAIL]`, `[OK]`
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Seed deterministic local telemetry fixtures")
    parser.add_argument("--db", default=str(ROOT / "data" / "tadpole.db"), help="Path to SQLite database")
    parser.add_argument("--force", action="store_true", help="Seed even when the database is already populated")
    arguments = parser.parse_args()
    seed_database(arguments.db, force=arguments.force)
