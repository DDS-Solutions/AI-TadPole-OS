...
### AI Assist Note
**📜 Sovereign Directives Knowledge Graph Parser**
Parses system directives, skills, workflows, error registries, and telemetry maps into a zero-token deterministic knowledge graph.

### 🔍 Debugging & Observability
- **Failure Path**: Parse error, missing directive, or schema mismatch.
- **Telemetry Link**: Search `[directives_graph]` in system logs.
"""
...
def main():
    ...
    print("==================================================")
    print(f"Generated Output: {out_path.relative_to(WORKSPACE_ROOT)}")
    print(f"Parsed Nodes: {graph['nodes_count']}")
    print(f"Parsed Edges: {graph['edges_count']}")
    print("--------------------------------------------------")
