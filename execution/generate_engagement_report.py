...
### AI Assist Note
**Engagement Report Generator (SOP-MKT-07)**: Queries local telemetry database
to generate structured markdown summaries of swarm signal strength, agent quotas,
and operational metrics.

### 🔍 Debugging & Observability
- **Failure Path**: sqlite3.Error when querying database or OS permission issues writing to reports/.
- **Telemetry Link**: Search `[generate_engagement_report]` in system logs.
"""
