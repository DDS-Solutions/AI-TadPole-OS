...
- **Subsystem**: Infrastructure Automation / analyze_user_feedback
- **Primary Entrypoints**: `analyze_sentiment`, `analyze_feedback`
...
- **Local Errors**: none
- **Telemetry Targets**: `[analyze_user_feedback]`, `[FAIL]`, `[OK]`
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, default=str(ROOT / "feedback_buffer.txt"), help="Path to input feedback text file")
