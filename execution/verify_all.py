...
- **Subsystem**: Infrastructure Automation / verify_all
- **Primary Entrypoints**: `run_script`, `print_final_report`, `main`
...
- **Local Errors**: none
- **Telemetry Targets**: `[:300]`, `[PASS]`, `[FAIL]`, `[SKIP]`, `[X]`
...
from py_utils import (
    ...
    print_header,
    print_step,
    print_ok as print_success,
    print_warn as print_warning,
    print_err as print_error,
)
...
VERIFICATION_SUITE = [
    # P0: Security (CRITICAL)
    {
        ...
        "checks": [
            ...
            ("SkillSpector Audit", "execution/skillspector_audit.py", True),
        ]
    },
    ...
    # P1: Code Quality (CRITICAL)
    {
        ...
        "checks": [
            ...
            ("Directives Knowledge Graph", "execution/parse_directives_graph.py", False),
            ("Symbol Gate", "execution/symbol_gate.py", True),
            ("Wiki Linter", "execution/wiki_ops.py", False),
        ]
    },
    ...
    # P10: Harness Governance
    {
        "category": "Harness Governance",
        "checks": [
            ("Event Logger Test", "execution/event_logger.py", True),
            ("Git Checkpoint Guard", "execution/git_checkpoint.py", True),
            ("Subagent Schema Validator", "execution/subagent_schema_validator.py", True),
        ]
    },
]
