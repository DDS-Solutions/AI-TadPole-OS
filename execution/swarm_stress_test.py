...
- **Subsystem**: Infrastructure Automation / swarm_stress_test
- **Primary Entrypoints**: `print_result`, `create_agent`, `main`
...
- **Local Errors**: none
- **Telemetry Targets**: `[FAIL]`, `[SECURITY]`, `[0]`, `[1]`, `[4]`, `[2]`
...
if not token:
    print("[FAIL] [SECURITY] NEURAL_TOKEN not found in environment.")
    sys.exit(1)
