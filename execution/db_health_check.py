...
- **Subsystem**: Infrastructure Automation / db_health_check
- **Primary Entrypoints**: `print_result`, `check_health`
...
if __name__ == "__main__":
    ...
    parser.add_argument("--db", type=str, default=str(ROOT / "data" / "tadpole.db"), help="Path to database")
