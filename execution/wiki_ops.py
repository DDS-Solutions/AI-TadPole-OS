...
- **Subsystem**: Infrastructure Automation / wiki_ops
- **Primary Entrypoints**: `parse_frontmatter`, `is_valid_code_identifier`, `get_wiki_files`, `generate_index`
...
- **Local Errors**: none
- **Telemetry Targets**: `[FAIL]`, `[OK]`, `[WARN]`
