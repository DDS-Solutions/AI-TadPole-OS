---
execution_contract:
  script: "execution/analyze_user_feedback.py"
  args:
    --input: "D:\\TadpoleOS-Dev\\feedback_buffer.txt"
    --output: "D:\\TadpoleOS-Dev\\reports"
  outputs:
    - "D:\\TadpoleOS-Dev\\reports\\USER_FEEDBACK_[MONTH].md"
---

> [!IMPORTANT]
> **AI Context & Knowledge Heritage**
> - **Subsystem**: Core Directives / user_feedback_analysis
> - **Architecture**: `@docs ARCHITECTURE:Documentation`
> - **Failure Path**: Information drift, legacy terminology, or documentation mismatch.
> - **Observability**: Traceability via `execution/parity_guard.py` (`[user_feedback_analysis]`)
