...
> - **Subsystem**: Core Directives / api_documentation
> - **Architecture**: `@docs ARCHITECTURE:Documentation`
> - **Failure Path**: Information drift, legacy terminology, or documentation mismatch.
> - **Observability**: Traceability via `execution/parity_guard.py` (`[api_documentation]`)
...
- **Validation**: Test against the `ProblemDetails` utility in `server-rs/src/error/mod.rs`.
