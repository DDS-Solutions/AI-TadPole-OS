...
> - **Subsystem**: Core Directives / risk_assessment
> - **Architecture**: `@docs ARCHITECTURE:Documentation`
> - **Failure Path**: Information drift, legacy terminology, or documentation mismatch.
> - **Observability**: Traceability via `execution/parity_guard.py` (`[risk_assessment]`)
...
- **Check**: Single points of failure in the `server-rs` hubs (e.g., `server-rs/src/state/mod.rs` thread-lock contention).
