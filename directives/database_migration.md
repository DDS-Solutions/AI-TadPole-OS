...
> - **Subsystem**: Core Directives / database_migration
> - **Architecture**: `@docs ARCHITECTURE:Documentation`
> - **Failure Path**: Information drift, legacy terminology, or documentation mismatch.
> - **Observability**: Traceability via `execution/parity_guard.py` (`[database_migration]`)
...
- [ ] **Schema Check**: Validate the migration SQL against `server-rs/migrations/`.
