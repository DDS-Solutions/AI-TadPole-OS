...
graph TD
    ...
    D --> F
    E --> F
    F --> G[security-auditor + tadpole-backend-specialist + customer-backend-specialist]
...
| ------------------- | ------------------------------------------ | ------------------------------------------- | ------------ |
| **Authentication**  | "login", "auth", "signup", "password"      | `security-auditor` + `tadpole-backend-specialist` + `customer-backend-specialist` | ✅ YES       |
| **UI Component**    | "button", "card", "layout", "style"        | `tadpole-frontend-specialist`               | ✅ YES       |
| **Mobile UI**       | "screen", "navigation", "touch", "gesture" | `mobile-developer`                          | ✅ YES       |
| **API Endpoint**    | "endpoint", "route", "API", "POST", "GET"  | `tadpole-backend-specialist`                | ✅ YES       |
| **Database**        | "schema", "migration", "query", "table"    | `database-architect` + `tadpole-backend-specialist` | ✅ YES       |
...
```markdown
🤖 **Applying knowledge of `@security-auditor` + `@tadpole-backend-specialist`...**
...
| **Frontend**    | component, react, vue, css, html, tailwind | `tadpole-frontend-specialist`   |
| **Backend**     | api, server, rust, axum, route, endpoint   | `tadpole-backend-specialist` |
| **Customer Backend** | customer, production, migration, PII, compatibility | `customer-backend-specialist` |
...
→ Orchestrator will handle: security-auditor, tadpole-frontend-specialist, test-engineer
```
...
```markdown
🤖 **Applying knowledge of `@tadpole-frontend-specialist`...**
...
```text
User: "Use @tadpole-backend-specialist to review this"
...
Expected: Auto-invoke tadpole-frontend-specialist
Verify: Response shows "Using @tadpole-frontend-specialist"
```
