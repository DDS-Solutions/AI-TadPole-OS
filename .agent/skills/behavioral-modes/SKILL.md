...
- **Constraint**: Proactively identify failure paths, trade-offs, and invariants. Cross-reference [.agent/skills/aletheia-reasoning/SKILL.md](../aletheia-reasoning/SKILL.md) for execution.
