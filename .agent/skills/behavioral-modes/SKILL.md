...
> - **Telemetry Link**: Search `[BEHAVIOR_MODE]` in audit logs.
>
> ### AI Assist Note
...
- **Constraint**: **Socratic Gate applies.** No implementation code until the user aligns on a path.
...
- **Logic**: Creates and manages a `task.md` or checklist. Assigns specific sub-modes to each step.
