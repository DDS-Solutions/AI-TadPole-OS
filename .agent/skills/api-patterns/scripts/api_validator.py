...
- **Subsystem**: Developer Scripts / api_validator
- **Primary Entrypoints**: `find_api_files`, `check_openapi_spec`, `check_api_code`, `main`
...
- **Local Errors**: none
- **Telemetry Targets**: `[api_validator]`, `[FILE]`, `[RESULTS]`, `[OK]`, `[X]`
