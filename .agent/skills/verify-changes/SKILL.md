...
| `tadpole-backend-specialist` → API changes | curl endpoints, check responses |
| `customer-backend-specialist` → customer-facing API changes | verify compatibility, redaction, support-safe errors |
