...
- **Subsystem**: Developer Scripts / react_performance_checker
- **Primary Entrypoints**: `PerformanceChecker`, `main`
...
- **Local Errors**: none
- **Telemetry Targets**: `[WARNINGS]`, `[SUCCESS]`, `[react_performance_checker]`, `[ERROR]`
