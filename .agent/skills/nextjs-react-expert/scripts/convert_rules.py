...
- **Subsystem**: Developer Scripts / convert_rules
- **Primary Entrypoints**: `parse_frontmatter`, `parse_rule_file`, `group_rules_by_section`, `generate_section_file`
...
- **Local Errors**: none
- **Telemetry Targets**: `[WARNING]`, `[OK]`, `[convert_rules]`, `[ERROR]`, `[SUCCESS]`
