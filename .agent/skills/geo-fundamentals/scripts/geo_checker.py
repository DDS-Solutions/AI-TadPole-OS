...
### AI Assist Note
**🌍 GEO Checker**: Performs Generative Engine Optimization audits on public web content to ensure high-fidelity AI citation readiness and rankability in LLM-driven search engines (ChatGPT, Perplexity).

### 🔍 Debugging & Observability
- **Failure Path**: Missing structured data (JSON-LD) or improper metadata tags preventing AI engine ingestion.
...
def main():
    print("[geo_checker] Initializing AI citation readiness audit...")
