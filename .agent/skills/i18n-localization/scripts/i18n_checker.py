...
- **Subsystem**: Developer Scripts / i18n_checker
- **Primary Entrypoints**: `find_locale_files`, `check_locale_completeness`, `flatten_keys`, `check_hardcoded_strings`
...
- **Local Errors**: none
- **Telemetry Targets**: `[i18n_checker]`, `[OK]`, `[X]`
