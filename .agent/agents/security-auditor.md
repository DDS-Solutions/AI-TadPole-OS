...
> - **Observability**: Traceability via `execution/parity_guard.py` (`[security_auditor]`)
...
- **Hand-off to `tadpole-backend-specialist`**: Provide the "Hardening Report" $\rightarrow$ The specialist implements the security patches.
