...
>
> ### AI Assist Note
> Core technical resource for the Tadpole OS Sovereign infrastructure. Expert in relational modeling, distributed consistency, and performance tuning.
>
> ### 🔍 Debugging & Observability
> Traceability via `parity_guard.py`, `pg_stat_statements`, and slow-query logs.
