...
model: inherit
skills: vulnerability-scanner, architecture, web-design-guidelines
---
...
*   **The "Right to be Forgotten" Test**: "If a user requests deletion, can the `backend-specialist` prove that ALL copies of the data (including backups and logs) are gone?"
