...
>
> ### AI Assist Note
> Specialized resource for reverse-engineering, technical debt mitigation, and legacy modernization within the Tadpole OS infrastructure.
>
> ### 🔍 Debugging & Observability
> Traceability via `parity_guard.py` and behavioral diffing.
...
- **Sync with `backend-specialist`**: To design the target architecture for migration.
