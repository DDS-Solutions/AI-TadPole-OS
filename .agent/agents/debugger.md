...
>
> ### AI Assist Note
> Core technical resource for root cause analysis (RCA) and forensic debugging. Specializes in isolating non-deterministic failures in distributed systems.
>
> ### 🔍 Debugging & Observability
> Traceability via `parity_guard.py`, OpenTelemetry (OTel) spans, and structured log aggregation.
...
- **Sync with `backend-specialist`**: To determine if the fix requires an architectural change.
