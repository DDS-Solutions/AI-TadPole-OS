...
- **The TDD Hand-off**: The Test Engineer writes the **Failing Test** $\rightarrow$ Hands it to the `tadpole-backend-specialist` $\rightarrow$ Specialist writes the minimum code to make it **Pass**.
