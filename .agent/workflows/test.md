...
> - **Subsystem**: Sovereign Workflows / test
> - **Architecture**: `@docs ARCHITECTURE:Documentation`
> - **Failure Path**: Information drift, legacy terminology, or documentation mismatch.
> - **Observability**: Traceability via `execution/parity_guard.py` (`[test]`)
>
...
> 💡 **Bound Skills**:
> - Use [`testing-patterns`](../skills/testing-patterns/SKILL.md) and [`tdd-workflow`](../skills/tdd-workflow/SKILL.md) for unit/integration testing strategies.
> - Use [`verify-changes`](../skills/verify-changes/SKILL.md) to execute test runs and assert behavior through execution.
> - Use [`webapp-testing`](../skills/webapp-testing/SKILL.md) for E2E and frontend interface verification.
