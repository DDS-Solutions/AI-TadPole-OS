...
### Light/Dark Mode Contrast (Sovereign Benchmarks)

| Rule | Do | Don't |
|------|----|----- |
| **Glass card light mode** | Use `bg-white/80` or higher opacity | Use `bg-white/10` (too transparent) |
| **Text contrast light** | Use `text-slate-900` (#0F172A) | Use `text-slate-400` (low contrast) |
| **Sovereign Accent** | Use the primary brand token (e.g., `text-primary-600`) | Use hardcoded arbitrary hex values |
| **Border visibility** | Use `border-slate-200` in light mode | Assume dark mode borders work in light |

### Layout & Spacing (Tailwind v4)

| Rule | Do | Don't |
|------|----|----- |
| **Floating navbar** | Add `top-4 left-4 right-4` spacing | Stick navbar to `top-0 left-0 right-0` |
| **Content padding** | Account for fixed navbar height (pt-24) | Let content hide behind fixed elements |
| **Registry Constraints** | Use the fixed container tokens from `tailwind.config.css` | Define ad-hoc random max-widths |
