...
> 💡 **Bound Skills**:
> - Use `@[skills/improve-codebase-architecture]` to generate interactive visual HTML refactoring cards (`.tmp/reports/architecture-review-<timestamp>.html`).
> - Use `@[skills/plan-writing]` to slice wide refactors into safe **Expand-Contract** batches (*Expand* $\rightarrow$ *Migrate* $\rightarrow$ *Contract*).
