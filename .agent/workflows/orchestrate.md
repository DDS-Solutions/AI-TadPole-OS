...
| **Runner** | `backend-specialist`, `debugger`, `test-engineer` | Business Logic, Intelligence Loops, State Transitions |
...
- **Core Group**: `backend-specialist` $\rightarrow$ `frontend-specialist`
...
| `backend-specialist` | Runner | API Implementation | ✅ |
