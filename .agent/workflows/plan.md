...
> - **Subsystem**: Sovereign Workflows / plan
> - **Architecture**: `@docs ARCHITECTURE:Documentation`
> - **Failure Path**: Information drift, legacy terminology, or documentation mismatch.
> - **Observability**: Traceability via `execution/parity_guard.py` (`[plan]`)
>
...
> 💡 **Multi-Session Epics**: For large multi-session initiatives wrapped in fog, use `@[skills/wayfinder]` to maintain a persistent decision map (`Destination`, `Decisions so far`, `Not yet specified`, `Out of scope`).
