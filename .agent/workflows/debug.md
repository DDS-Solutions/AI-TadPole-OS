...
> - **Subsystem**: Sovereign Workflows / debug
> - **Architecture**: `@docs ARCHITECTURE:Documentation`
> - **Failure Path**: Information drift, legacy terminology, or documentation mismatch.
> - **Observability**: Traceability via `execution/parity_guard.py` (`[debug]`)
...
> Use [`systematic-debugging`](../skills/systematic-debugging/SKILL.md) and [`code-review-graph`](../skills/code-review-graph/SKILL.md) to build a fast (<2s), deterministic, red-capable reproduction script BEFORE touching code or formulating hypotheses.
...
- **Action**: Run `npm run graph:blast:guard -- --path [affected_file]`
