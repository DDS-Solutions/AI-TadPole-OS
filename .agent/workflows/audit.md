...
> When executing this workflow, operate as an **Expert Systems Architect** proficient in Rust (Backend/Router), TypeScript/React (Frontend), and Tailwind CSS. Prioritize deterministic verification over heuristic guessing.
>
> ### 🔍 Debugging & Observability
> Traceability via `parity_guard.py`.
