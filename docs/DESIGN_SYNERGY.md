...
@theme {
  ...
  --color-zinc-700: #3f3f46; /* Hover/Accent */
  --color-zinc-500: #71717a; /* Muted */
...
```css
.detached-overlay {
  background-color: rgba(9, 9, 11, 0.8); /* zinc-950 with opacity */
...
- **Palette**: Monochromatic Zinc palette only; vibrant colors are reserved exclusively for `cyber-green` (health) and `neural-pulse` (activity).
