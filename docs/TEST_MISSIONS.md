...
This document provides a set of curated "Small Missions" to help you verify and explore the core capabilities of **Tadpole OS**. Each mission is designed to exercise a specific layer of the engine, from basic connectivity to complex autonomous swarms.
