...
> **Version**: 1.2.0
> **Last Updated**: 2026-03-28 (Governance/State Parity Sync)
...
- **[Component] God View (Telemetry Graph):** (New) A real-time, hierarchical visualization of the swarm's execution flow.
    - **Live Tracing**: Visualizes the "Chain of Thought" using OTel-compliant spans.
    - **Multi-Scope Toggles**: Switch between Global Swarm and Mission-specific views.
    - **Node Interaction**: Click any span in the graph to view low-level telemetry, including model parameters and tool output.
...
These kits are located in the `starter_kits/` directory. See the [Starter Kits Guide](file:///c:/Users/Home%20Office_PC/.gemini/antigravity/playground/tadpole-os/docs/STARTER_KITS.md) for full persona profiles and workflows.
