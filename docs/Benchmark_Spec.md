...
> - **Primary Claims**: Parallel Swarming (70% latency reduction), batched agent persistence, Zero-Overhead Rate Limiting (<1ms).
...
bashexport NEURAL_TOKEN="YOUR_NEURAL_TOKEN"
export DATABASE_URL="sqlite://$(pwd)/bench_test.db"
...
# Pass condition: 50-agent time stays within an acceptable operational multiple of the 5-agent case and avoids transaction/fsync spikes
