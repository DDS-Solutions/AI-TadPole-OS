...
> - **Subsystem**: Architecture & Documentation / Core Docs / Benchmark_Spec
...
- [4. Baseline Management & Delta Analysis](#4-baseline-management--delta-analysis)
  ...
  - [BM-RUN — Agent Runner](#bm-run--agent-runner-runnermodrs)
  ...
  - [BM-WS — WebSocket & Event Bus](#bm-ws--websocket--event-bus-routeswsrs)
  ...
  - [BM-SEC — Security & Integrity](#bm-sec--security--integrity-securitymodrs-securityauditrs-securitymonitoringrs)
...
- [Agent Runner — Entry](../server-rs/src/agent/runner/mod.rs)
- [Agent Runner — Swarm Dispatch](../server-rs/src/agent/runner/swarm/dispatcher.rs)
- [Agent Runner — Conductor](../server-rs/src/agent/runner/conductor.rs)
- [Rate Limiter](../server-rs/src/agent/rate_limiter.rs)
- [MCP Subprocesses](../server-rs/src/agent/mcp/mod.rs)
- [Filesystem Adapter Sandbox](../server-rs/src/adapter/filesystem.rs)
- [WebSocket Handler](../server-rs/src/routes/ws.rs)
- [Security / Audit Module](../server-rs/src/security/mod.rs)
- [Benchmark Agent Module](../server-rs/src/agent/benchmarks.rs)
