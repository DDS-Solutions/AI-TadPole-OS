...
> **Status**: Stable  
> **Version**: 1.2.0  
> **Last Updated**: 2026-06-17 (Open Knowledge Format (OKF) & Compactor Hardening)  
...
- `server-rs/src/agent/knowledge_store.rs` governs SQLite-backed IKS and OKF metadata storage.
