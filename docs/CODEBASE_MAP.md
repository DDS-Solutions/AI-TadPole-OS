...
| `components/` | **Units** | `AgentConfigPanel.tsx`, `SovereignChat.tsx`, `CommandPalette.tsx`, `PageHeader.tsx`, `TabBar.tsx`, `TabItem.tsx`, `PortalWindow.tsx`, `CommandTable.tsx`, `SwarmOversightNode.tsx`, `ImportPreviewModal.tsx` |
