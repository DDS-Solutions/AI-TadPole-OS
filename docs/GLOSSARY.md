...
> **Status:** Verified  
> **Version:** 1.1.4  
> **Audience:** Operators, Developers, and AI Assistants
...
### Resource Guard
The real-time telemetry subsystem responsible for hardware-level monitoring (CPU, RAM) and sandbox discovery. Proactively alerts operators on resource pressure before failures occur.
