...
> [!NOTE]
> Keyboard shortcuts are active only when no input fields are focused. Cited in [useLayoutNavigation.ts:L51-83](../src/hooks/layout/useLayoutNavigation.ts#L51-L83).
