...
> [!NOTE]
> This page is a summary reference. For the full architectural specification, see [`ARCHITECTURE.md`](../docs/ARCHITECTURE.md) in the main repository.
