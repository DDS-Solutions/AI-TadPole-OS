...
**Last Hardened**: 2026-04-27 (MFS & Vector Parity)  
...
|:--- |:--- |:--- |:--- |
| **Deterministic** | **SQLite (sqlx)** | Logs, Budgets, Registry, Metadata, OKF Metadata | Legal Audit & Operational Truth |
...
Tadpole OS doesn't just rely on raw vector similarity. It uses a **Multi-Factor Scoring (MFS)** engine to rank context snippets based on three primary signals:
...
The MFS engine reranks these signals into a unified relevance score (0.0 - 1.0) before passing the top-K snippets to the LLM.
