...
> **Version**: 1.0.0
> **Last Updated**: 2026-03-22 (Verified 100% Quality Pass)

> **Prerequisites**: Tadpole OS running locally (`start_tadpole.bat`) or deployed on your Swarm Bunker. You'll need API keys for your preferred providers (Anthropic, OpenAI, Groq) or a local Ollama instance.
...
7. **Voice & Governance Tabs**:
   - Configure TTS/STT identity and USD budget caps.
