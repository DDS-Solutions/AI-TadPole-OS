...
> **Version**: 1.1.0
> **Last Updated**: 2026-03-23 (Modernized 100% Industry Standard)
...
For rapid SME deployment, Tadpole OS includes **Sovereign Starter Kits** (Marketing, Customer Success, Finance). See the full [Starter Kits Guide](file:///c:/Users/Home%20Office_PC/.gemini/antigravity/playground/tadpole-os/docs/STARTER_KITS.md) for instructions on "one-click" swarm installation.

---

## Step 4: Local Intelligence (Local LLMs via Ollama)
2. Follow the [Qwen3.5-9B Local Integration Guide](file:///c:/Users/Home%20Office_PC/.gemini/antigravity/playground/tadpole-os/docs/QWEN_LOCAL_INTEGRATION.md) for detailed setup.
