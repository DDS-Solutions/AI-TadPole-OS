...
For rapid SME deployment, Tadpole OS allows you to choose a **Sovereign Starter Kit** (Marketing, Customer Success, Finance). See the full [Starter Kits Guide](docs/STARTER_KITS.md) for instructions on "one-click" swarm installation.

---

## Step 4: Local Intelligence (Local LLMs via Ollama)

1. Follow the [Qwen3.5-9B Local Integration Guide](docs/QWEN_LOCAL_INTEGRATION.md) for detailed setup.
...
The main **Operations Center** features a high-performance **Swarm Visualizer**:
