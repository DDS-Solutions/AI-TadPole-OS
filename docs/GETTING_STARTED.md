...
- **Persistence**: Agent roles and system configurations are stored in the backend **SQLite database** (`data/tadpole.db`). Logical mission clusters are managed by the frontend in **LocalStorage**.
