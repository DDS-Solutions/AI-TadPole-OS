...
- **SQLite Transaction Ledger**: Persists all financial transactions in the `agent_transactions` table under the local database, providing a non-repudiable cryptographically audited transaction ledger.
