...
- **Handler**: `pub async fn get_agents` in `agent/crud.rs`
...
- **Handler**: `pub async fn get_agent` in `agent/crud.rs`
...
- **Handler**: `pub async fn send_task` in `agent/tasks.rs`
...
- **Endpoint**: `GET /v1/intelligence/impacted-tests`
- **Handler**: `pub async fn get_impacted_tests` in `intelligence.rs`
