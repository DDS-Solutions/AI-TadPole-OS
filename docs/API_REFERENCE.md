...
|--------|------|------|-------------|
| `GET` | `/v1/health` | ✗ | Engine Terminal Diagnostics |
...
| `PUT` | `/v1/skills/hooks/{name}` | ✓ | Save or update a system hook |
| `PUT` | `/v1/skills/scripts/{name}` | ✓ | Save or update a script skill |
| `PUT` | `/v1/skills/skills/{name}` | ✓ | Save or update a skill |
| `PUT` | `/v1/skills/workflows/{name}` | ✓ | Save or update a workflow |
| `DELETE` | `/v1/skills/hooks/{name}` | ✓ | Delete a system hook |
| `DELETE` | `/v1/skills/scripts/{name}` | ✓ | Delete a script skill |
| `DELETE` | `/v1/skills/skills/{name}` | ✓ | Delete a skill |
| `DELETE` | `/v1/skills/workflows/{name}` | ✓ | Delete a workflow |
...
| `recruit_specialist(agentId: string, message: string)` | `{ "agentId": "...", "message": "..." }` | Request assistance from a specialized agent within the same cluster. Delegates to the engine's `spawn_subagent` logic. |
