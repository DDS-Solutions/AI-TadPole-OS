...
| `POST` | `/v1/oversight/security/verify` | ✓ | Verify audit chain integrity |
...
| Method | Path | Auth | Description |
|--------|------|------|-------------|
| `GET` | `/v1/skills` | ✓ | List all dynamic skills |
| `GET` | `/v1/skills/skills/{name}` | ✓ | Get a specific skill manifest |
