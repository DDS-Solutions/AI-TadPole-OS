...
- Envelopes sent via `A2AMailbox` preserve model reasoning traces and list of file artifacts
...
5.  **Sovereign Directives**: Global identity and institutional memory files from `directives/`.

---

## 📁 Implementation Map (v1.1.231)
