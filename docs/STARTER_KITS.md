...
### 4. Explorer Scout ("Aegis")
**Goal**: Search GitHub, analyze repositories, and find projects like AI-Tadpole-OS.
- **Lead Agent**: Aegis (Research Director)
- **Specialists**: Seeker (GitHub Specialist), Analyst.
- **Workflow**: `github_scout.md`.
- **Swarm Pulse**: Pre-configured for high-frequency telemetry during repository deep-dives.
...
- **Swarm_Visualizer**: All kits include optimized 2D force-graph coordinates for immediate topological clarity upon deployment.
