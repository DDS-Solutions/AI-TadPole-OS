...
> [!IMPORTANT]
> The engine binds to `10.0.0.1:8000` within the container. You do NOT need port `5173` on the target host; that is for local development only. Ensure your firewall allows traffic on port `8000`.
