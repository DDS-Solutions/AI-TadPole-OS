...
The engine will start on `http://localhost:8000`. **The API is now live and ready for agent missions.**
...
- **[🏠 Architecture Hub](docs/ARCHITECTURE.md)**: Technical entry point and documentation index.
- **[🏗️ Architecture Overview](docs/Architecture_Overview.md)**: Executive summary and system topology.
- **[🛡️ Security Model](docs/Security_Model.md)**: Governance, Merkle trails, and Budget Guard.
- **[🤖 Agent Runner](docs/Agent_Runner_Workflow.md)**: Execution lifecycle and swarm protocols.
- **[🧠 Memory & RAG](docs/Knowledge_Memory.md)**: Hybrid RAG and metadata parsing.
- **[⚛️ Client Architecture](docs/Frontend_State_Management.md)**: React 19, Zustand, and Portal sync.
- **[🛰️ API Contract](docs/API_CONTRACT.md)**: Standardized REST endpoint reference.
- **[📡 WebSocket Events](docs/WEBSOCKET_EVENTS.md)**: Transport layer and binary pulse protocols.
- **[🛠️ CLI Tools](docs/CLI_TOOLS.md)**: Mission debriefing and parity audit tools.
- **[🚧 Troubleshooting](docs/TROUBLESHOOTING.md)**: Diagnostics for swarm and engine issues.

---

## 🚀 First Principles: Running a Live Swarm

To move from reading about these capabilities to using them, follow the **[Getting Started](#-getting-started)** guide below. You'll move through environmental configuration, engine deployment, and your first autonomous task in under five minutes.
...
We welcome Overlords! Tadpole OS is built on the principle of distributed intelligence. Whether you are fixing bugs, improving the RAG pipeline, or sharing a new Industry Template—your contributions harden the sovereignty of the entire swarm.
