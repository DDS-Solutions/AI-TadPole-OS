...
Generates mipmap icons for mobile-android app from source logo.

### 🔍 Debugging & Observability
- **Failure Path**: Missing source logo file or invalid image resolution.
- **Telemetry Link**: Search `[android_icons]` in system logs.
"""
...
def generate_android_icons():
    source_path = r"d:\TadpoleOS-Dev\public\assets\logo.png"
    base_res_dir = r"d:\TadpoleOS-Dev\apps\mobile-android\app\src\main\res"
