...
- [ ] **Shadow Identity Field**: `shadows_human_id: Option<String>` on `EngineAgent` to map agentic tasks to specific human user IDs.
- [ ] **Agent Config Panel**: "Shadows Real Person" field in UI to configure human-agent pairs.
