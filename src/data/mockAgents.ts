...
export const agents: Agent[] = [
  ...
  { category: 'ai', id: '11', name: 'Back-3', role: 'Backend Dev', department: 'Engineering', status: 'idle', tokensUsed: 9000, model: 'GPT-5.3 Codex', workspacePath: './workspaces/back-3', currentTask: undefined, reportsTo: '9', skills: ['database_query'], workflows: ['refactor_microservice'] },

  // Engineering - Ops/Sec
  { category: 'ai', id: '12', name: 'Sec-1', role: 'Security Auditor', department: 'Engineering', status: 'active', tokensUsed: 1200, model: 'Claude Sonnet 4.5', workspacePath: './workspaces/sec-1', currentTask: 'Running vulnerability scan on auth module', reportsTo: '3', skills: ['scan_vulnerabilities'], workflows: ['security_audit'] },
  { category: 'ai', id: '13', name: 'Ops-1', role: 'DevOps', department: 'Engineering', status: 'active', tokensUsed: 25000, model: 'Gemini 3 Flash', workspacePath: './workspaces/ops-1', currentTask: 'Scaling K8s cluster node pool', reportsTo: '3', skills: ['check_server_health'], workflows: ['scale_cluster'] },

  // Product
  { category: 'ai', id: '14', name: 'Prod-1', role: 'Product Manager', department: 'Product', status: 'thinking', tokensUsed: 14000, model: 'GPT-5.2', workspacePath: './workspaces/prod-1', currentTask: 'Defining roadmap for Q4', reportsTo: '2', skills: ['write_spec'], workflows: ['sprint_planning'] },
  { category: 'ai', id: '15', name: 'Des-1', role: 'Designer', department: 'Product', status: 'active', tokensUsed: 15000, model: 'Gemini 3 Pro', workspacePath: './workspaces/des-1', currentTask: 'Generating assets for landing page', reportsTo: '14', skills: ['generate_image'], workflows: ['design_system_update'] },
  { category: 'ai', id: '16', name: 'Res-1', role: 'Researcher', department: 'Product', status: 'idle', tokensUsed: 5000, model: 'DeepSeek R1', workspacePath: './workspaces/res-1', currentTask: undefined, reportsTo: '14', skills: ['market_research'], workflows: ['User Feedback Analysis'] },

  // Marketing
  { category: 'ai', id: '17', name: 'Copy-1', role: 'Copywriter', department: 'Marketing', status: 'active', tokensUsed: 8000, model: 'Claude Sonnet 4', workspacePath: './workspaces/copy-1', currentTask: 'Drafting launch newsletter', reportsTo: '4', skills: ['copywriting'], workflows: ['campaign_launch'] },
  { category: 'ai', id: '18', name: 'Social-1', role: 'Social Media', department: 'Marketing', status: 'active', tokensUsed: 12000, model: 'Grok 4.1', workspacePath: './workspaces/social-1', currentTask: 'Scheduling tweets for improved engagement', reportsTo: '4', skills: ['post_update'], workflows: ['social_strategy'] },
  { category: 'ai', id: '19', name: 'SEO-1', role: 'SEO Specialist', department: 'Marketing', status: 'thinking', tokensUsed: 11000, model: 'GPT-5.2', workspacePath: './workspaces/seo-1', currentTask: 'Analyzing keyword density for blog posts', reportsTo: '4', skills: ['seo_analysis'], workflows: ['market_trend_analysis'] },

  // Sales
  { category: 'ai', id: '20', name: 'SDR-1', role: 'Sales Rep', department: 'Sales', status: 'offline', tokensUsed: 2000, model: 'o4-mini', workspacePath: './workspaces/sdr-1', currentTask: undefined, reportsTo: '5', skills: ['lead_qualification'], workflows: ['quarterly_forecasting'] },
  { category: 'ai', id: '21', name: 'SDR-2', role: 'Sales Rep', department: 'Sales', status: 'offline', tokensUsed: 2000, model: 'o4-mini', workspacePath: './workspaces/sdr-2', currentTask: undefined, reportsTo: '5', skills: ['lead_qualification'], workflows: ['quarterly_forecasting'] },

  // Operations
  { category: 'ai', id: '22', name: 'Hr-1', role: 'HR Manager', department: 'Operations', status: 'idle', tokensUsed: 3000, model: 'Claude Sonnet 4', workspacePath: './workspaces/hr-1', currentTask: undefined, reportsTo: '2', skills: ['employee_onboarding'], workflows: ['policy_review'] },
  { category: 'ai', id: '23', name: 'Fin-1', role: 'Finance Analyst', department: 'Operations', status: 'thinking', tokensUsed: 9000, model: 'GPT-5.2', workspacePath: './workspaces/fin-1', currentTask: 'Forecasting burn rate', reportsTo: '2', skills: ['analyze_budget'], workflows: ['finance_review'] },
  { category: 'ai', id: '24', name: 'Leg-1', role: 'Legal Advisor', department: 'Operations', status: 'idle', tokensUsed: 4000, model: 'Claude Opus 4.5', workspacePath: './workspaces/leg-1', currentTask: undefined, reportsTo: '2', skills: ['contract_review'], workflows: ['risk_assessment'] },
  { category: 'ai', id: '25', name: 'Sup-1', role: 'Support Agent', department: 'Operations', status: 'active', tokensUsed: 16000, model: 'Qwen 3', workspacePath: './workspaces/sup-1', currentTask: 'Resolving ticket #9281', reportsTo: '2', skills: ['ticket_triage'], workflows: ['customer_incident_review'] },
  { category: 'ai', id: '26', name: 'Checkmate', role: 'Quality Auditor', department: 'Quality Assurance', status: 'active', tokensUsed: 500, model: 'Claude Sonnet 4.5', workspacePath: './workspaces/checkmate', currentTask: 'Verifying system robustness', reportsTo: '1', skills: ['code_audit', 'system_audit'], workflows: ['compliance_check'] },
  {
    category: 'ai', id: '99',
    name: 'QA-99',
    ...
    budgetUsd: 10.0,
    model: 'Gemini 3 Pro',
    workspacePath: './workspaces/qa-99',
    skills: [],
    workflows: [],
    modelConfig: {
      modelId: 'gemini-3-pro',
