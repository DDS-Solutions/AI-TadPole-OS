...
export const agents: Agent[] = [
  // Executive
  {
    ...
    model_2: 'gemma4:31b-cloud',
    model_3: 'gemma4:31b-cloud',
    model_config: {
  ...
  { category: 'ai', id: '11', name: 'Back-3', role: 'Backend Dev', department: 'Engineering', status: 'offline', tokens_used: 9000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/back-3', current_task: undefined, reports_to: '9', skills: ['database_query'], workflows: ['refactor_microservice'] },

  // Engineering - Ops/Sec
  { category: 'ai', id: '12', name: 'Sec-1', role: 'Security Auditor', department: 'Engineering', status: 'offline', tokens_used: 1200, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/sec-1', current_task: 'Running vulnerability scan on auth module', reports_to: '3', skills: ['scan_vulnerabilities', 'vulnerability-scanner', 'red-team-tactics', 'pii-redaction'], workflows: ['security_audit', '/audit', '/adversary'] },
  { category: 'ai', id: '13', name: 'Ops-1', role: 'DevOps', department: 'Engineering', status: 'offline', tokens_used: 25000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/ops-1', current_task: 'Scaling K8s cluster node pool', reports_to: '3', skills: ['check_server_health', 'server-management', 'deployment-procedures'], workflows: ['scale_cluster', '/deploy'] },

  // Product
  { category: 'ai', id: '14', name: 'Prod-1', role: 'Product Manager', department: 'Product', status: 'offline', tokens_used: 14000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/prod-1', current_task: 'Defining roadmap for Q4', reports_to: '2', skills: ['write_spec', 'plan-writing'], workflows: ['sprint_planning', '/plan'] },
  { category: 'ai', id: '15', name: 'Des-1', role: 'Designer', department: 'Product', status: 'offline', tokens_used: 15000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/des-1', current_task: 'Generating assets for landing page', reports_to: '14', skills: ['generate_image', 'web-design-guidelines'], workflows: ['design_system_update'] },
  { category: 'ai', id: '16', name: 'Res-1', role: 'Researcher', department: 'Product', status: 'offline', tokens_used: 5000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/res-1', current_task: undefined, reports_to: '14', skills: ['market_research', 'explorer-scout', 'smb-data-ingestion'], workflows: ['User Feedback Analysis', '/github_scout', '/codify'] },

  // Marketing
  { category: 'ai', id: '17', name: 'Copy-1', role: 'Copywriter', department: 'Marketing', status: 'offline', tokens_used: 8000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/copy-1', current_task: 'Drafting launch newsletter', reports_to: '4', skills: ['copywriting', 'documentation-templates', 'digital-twin-voice'], workflows: ['campaign_launch', '/report'] },
  { category: 'ai', id: '18', name: 'Social-1', role: 'Social Media', department: 'Marketing', status: 'offline', tokens_used: 12000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/social-1', current_task: 'Scheduling tweets for improved engagement', reports_to: '4', skills: ['post_update'], workflows: ['social_strategy'] },
  { category: 'ai', id: '19', name: 'SEO-1', role: 'SEO Specialist', department: 'Marketing', status: 'offline', tokens_used: 11000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/seo-1', current_task: 'Analyzing keyword density for blog posts', reports_to: '4', skills: ['seo_analysis', 'seo-fundamentals'], workflows: ['market_trend_analysis'] },

  // Sales
  { category: 'ai', id: '20', name: 'SDR-1', role: 'Sales Rep', department: 'Sales', status: 'offline', tokens_used: 2000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/sdr-1', current_task: undefined, reports_to: '5', skills: ['lead_qualification'], workflows: ['quarterly_forecasting'] },
  { category: 'ai', id: '21', name: 'SDR-2', role: 'Sales Rep', department: 'Sales', status: 'offline', tokens_used: 2000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/sdr-2', current_task: undefined, reports_to: '5', skills: ['lead_qualification'], workflows: ['quarterly_forecasting'] },

  // Operations
  { category: 'ai', id: '22', name: 'Hr-1', role: 'HR Manager', department: 'Operations', status: 'offline', tokens_used: 3000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/hr-1', current_task: undefined, reports_to: '2', skills: ['employee_onboarding'], workflows: ['policy_review'] },
  { category: 'ai', id: '23', name: 'Fin-1', role: 'Finance Analyst', department: 'Operations', status: 'offline', tokens_used: 9000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/fin-1', current_task: 'Forecasting burn rate', reports_to: '2', skills: ['analyze_budget'], workflows: ['finance_review'] },
  { category: 'ai', id: '24', name: 'Leg-1', role: 'Legal Advisor', department: 'Operations', status: 'offline', tokens_used: 4000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/leg-1', current_task: undefined, reports_to: '2', skills: ['contract_review'], workflows: ['risk_assessment'] },
  { category: 'ai', id: '25', name: 'Sup-1', role: 'Support Agent', department: 'Operations', status: 'offline', tokens_used: 16000, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/sup-1', current_task: 'Resolving ticket #9281', reports_to: '2', skills: ['ticket_triage'], workflows: ['customer_incident_review'] },
  { category: 'ai', id: '26', name: 'Checkmate', role: 'Quality Auditor', department: 'Quality Assurance', status: 'offline', tokens_used: 500, budget_usd: 10.0, model: 'gemma4:31b-cloud', model_2: 'gemma4:31b-cloud', model_3: 'gemma4:31b-cloud', workspace_path: './workspaces/checkmate', current_task: 'Verifying system robustness', reports_to: '1', skills: ['code_audit', 'system_audit', 'vulnerability-scanner', 'lint-and-validate', 'verify-changes'], workflows: ['compliance_check', '/audit', '/test'] },
  {
    category: 'ai', id: '99',
    name: 'QA-99',
