...
export const agents: Agent[] = [
  // Executive
  {
    ...
    model_config: {
      ...
      provider: 'openai',
      temperature: 0.7,
      system_prompt: 'You are the primary strategic intelligence.',
    ...
    model_config2: {
      ...
      provider: 'anthropic',
      temperature: 0.5,
      system_prompt: 'You are the critical reviewer and risk assessor.',
    ...
    model_config3: {
      ...
      provider: 'meta',
      temperature: 0.9,
      system_prompt: 'You are the creative divergent thinker.',
  ...
  },
  {
    ...
    model_config2: {
      ...
      provider: 'openai',
      temperature: 0.6,
      system_prompt: 'Backup strategic model',
  ...
  },
  {
    ...
    model_config2: {
      ...
      provider: 'openai',
      temperature: 0.05,
      system_prompt: 'Code generation expert',
    ...
    model_config3: {
      ...
      provider: 'deepseek',
      temperature: 0.2,
      system_prompt: 'Legacy code refactoring',
  ...
  { category: 'ai', id: '26', name: 'Checkmate', role: 'Quality Auditor', department: 'Quality Assurance', status: 'active', tokens_used: 500, model: 'Claude Sonnet 4.5', workspace_path: './workspaces/checkmate', current_task: 'Verifying system robustness', reports_to: '1', skills: ['code_audit', 'system_audit'], workflows: ['compliance_check'] },
  {
    ...
    model_config: {
      ...
      provider: 'google',
      temperature: 0.7,
      system_prompt: 'You are the quality assurance agent. Analyze missions for correctness and completeness.',
      skills: [],
      workflows: []
    }
  }
