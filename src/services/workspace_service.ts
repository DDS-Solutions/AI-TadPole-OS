...
class Workspace_Service {
    ...
    public async sync_quotas(): Promise<void> {
        try {
            ...
            const store = workspace_store!.getState();
            ...
            workspace_store!.setState({ clusters: updated_clusters });
        } catch (error) {
    ...
    public async create_mission_cluster(mission: Partial<Mission_Cluster>): Promise<void> {
        ...
        const { clusters } = workspace_store!.getState();
        ...
        workspace_store!.setState(state => ({
    ...
    public async refresh_telemetry(): Promise<void> {
        try {
            ...
            workspace_store!.setState({ sync_status: next_status });
        } catch (error) {
