...
export const tadpole_os_service = {
    ...
    get delete_role_blueprint() { return agent_api_service.delete_role_blueprint; },
    ...
    get get_security_snapshot() { return system_api_service.oversight.get_security_snapshot; },
