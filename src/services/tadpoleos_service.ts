 ...
 * - **Subsystem**: Frontend Service Layer / tadpoleos_service
 * - **Primary Entrypoints**: `tadpole_os_service`
 *
...
export const tadpole_os_service = {
    ...
    delete_agent: agent_api_service.delete_agent,
    ...
    get_role_blueprints: agent_api_service.get_role_blueprints,
    ...
    get_knowledge: intelligence_api_service.get_knowledge,
    get_knowledge_peers: intelligence_api_service.get_knowledge_peers
};
