 ...
 * - **Subsystem**: Frontend Service Layer / voice_client.test
 *
...
describe('Voice_Client', () => {
    ...
    it('should start and stop recording', async () => {
        const started = await voice_client_instance.start_recording();
