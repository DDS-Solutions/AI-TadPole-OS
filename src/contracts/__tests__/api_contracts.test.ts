 ...
 * - **Telemetry Link**: Search `[api_contracts_test]` in observability traces.
 */

/**
 * @docs ARCHITECTURE:Contracts
 * 
 * ### API Contract Alignment Test Suite
 * This test parses the backend OpenAPI specification (`docs/openapi.yaml`)
 * and the frontend auto-generated contracts (`src/contracts/generated.ts`)
 * to verify they are synchronized, preventing structural drift between 
 * API specifications and frontend types.
 */
