    ...
    return (
        <div className="p-6 space-y-6 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                <Tooltip content={i18n.t('oversight.pending_actions_tooltip')} position="top">
                    <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-lg flex items-center justify-between cursor-help">
                        <div>
                ...
                <Tooltip content={i18n.t('oversight.approved_tooltip')} position="top">
                    <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-lg flex items-center justify-between cursor-help">
                        <div>
                ...
                <Tooltip content={i18n.t('oversight.rejected_tooltip')} position="top">
                    <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-lg flex items-center justify-between cursor-help">
                        <div>
                ...
                <Tooltip content={i18n.t('oversight.halt_agents_tooltip')} position="top">
                    <button
                ...
                <Tooltip content={i18n.t('oversight.kill_engine_tooltip')} position="top">
                    <button
