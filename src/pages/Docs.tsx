 ...
 * - **Subsystem**: UI Pages / Docs
 * - **Primary Entrypoints**: `Docs`
 *
                    ...
                    {activeTab === 'knowledge' ? (
                        <>
                            <div className="relative mb-6">
                                ...
                                <input
                                    type="text"
                                    aria-label={i18n.t('docs.search_placeholder')}
                            ...
                            <footer className="mt-24 pt-12 border-t border-zinc-800/80 flex flex-wrap items-center justify-between gap-8 text-zinc-500 not-prose">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[10px] uppercase tracking-[0.2em] font-black text-zinc-600">{i18n.t('docs.footer_role')}</span>
                                        <span className="text-sm font-bold text-zinc-400">{i18n.t('docs.footer_author')}</span>
                                    </div>
                                </div>
                                <div className="flex flex-col md:items-end gap-1">
                                    <span className="text-[10px] uppercase tracking-[0.2em] font-black text-zinc-600">{i18n.t('docs.footer_classification')}</span>
                                    <span className="text-xs font-mono px-3 py-1 bg-zinc-800/50 rounded-full border border-zinc-700/30 text-emerald-500/80">{i18n.t('docs.footer_level')}</span>
                                </div>
                                <div className="flex flex-col md:items-end gap-1">
                                    <span className="text-[10px] uppercase tracking-[0.2em] font-black text-zinc-600">{i18n.t('docs.footer_integrity')}</span>
