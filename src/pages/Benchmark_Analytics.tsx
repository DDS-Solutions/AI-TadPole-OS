...
const Benchmark_Analytics: React.FC = () => {
    ...
    return (
        <div className="p-6 space-y-6 max-w-7xl mx-auto text-zinc-100">
            {/* Structured Data & Semantic Header */}
                ...
                <div className="flex gap-4">
                    <Tooltip content={i18n.t('benchmark.tooltip_runner')} position="bottom">
                        <button
                            ...
                            className="px-4 py-2 bg-green-600 hover:bg-green-500 text-white font-bold rounded-lg text-[10px] transition-all flex items-center gap-2 shadow-lg shadow-green-500/20 disabled:opacity-50 uppercase tracking-widest cursor-pointer"
                        >
                    ...
                    <Tooltip content={i18n.t('benchmark.tooltip_rl')} position="bottom">
                        <button
                            ...
                            disabled={runningId !== null}
                            className="px-4 py-2 bg-cyan-600 hover:bg-cyan-500 text-white font-bold rounded-lg text-[10px] transition-all flex items-center gap-2 shadow-lg shadow-cyan-500/20 disabled:opacity-50 uppercase tracking-widest cursor-pointer"
                        >
