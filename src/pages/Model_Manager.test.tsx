 ...
 * - **Subsystem**: UI Pages / Model_Manager.test
 *
 ...
 * - **Witness Tests**: `Model_Manager.test.tsx`
 */
...
const {
    ...
    mock_unlock: vi.fn(),
    mock_lock: vi.fn(),
    mock_add_provider: vi.fn(),
    mock_delete_provider: vi.fn(),
    mock_edit_provider: vi.fn(),
    mock_add_model: vi.fn(),
    mock_edit_model: vi.fn(),
    mock_delete_model: vi.fn()
}));
...
vi.mock('../services/provider_service', () => ({
    provider_service: {
        add_provider: mock_add_provider,
        delete_provider: mock_delete_provider,
        set_provider_config: mock_edit_provider,
    }
}));
