...
describe('Docs Page', () => {
    ...
    beforeEach(() => {
        ...
        (system_api_service.docs.get_knowledge_docs as any).mockResolvedValue(mock_docs_list);
        (system_api_service.docs.get_knowledge_doc as any).mockResolvedValue('# Knowledge Doc Content');
        (system_api_service.docs.get_operations_manual as any).mockResolvedValue('# Operations Manual Content\n## First Section');
    });
    ...
    it('fetches and auto-selects a document containing "architecture" on load', async () => {
        ...
        expect(system_api_service.docs.get_knowledge_doc).toHaveBeenCalledWith('Architecture', 'architecture-overview');
    ...
    it('allows selecting a different document', async () => {
        ...
        expect(system_api_service.docs.get_knowledge_doc).toHaveBeenCalledWith('API', 'rest-api');
    });
    ...
    it('handles fetch failures gracefully', async () => {
        ...
        (system_api_service.docs.get_knowledge_doc as any).mockRejectedValue(new Error('Network error 500'));
