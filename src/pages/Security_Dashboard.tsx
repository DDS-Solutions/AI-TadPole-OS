        ...
        <div className="p-6 space-y-6 max-w-7xl mx-auto" aria-label="Security Dashboard">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-xl">
                    ...
                    <p className="text-2xl font-bold text-zinc-100">${quotas_state?.total_spent.toFixed(2)}</p>
                ...
                <div className="p-4 border-b border-zinc-800 bg-zinc-900/50 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <button 
                            ...
                            className={`px-3 py-1 rounded text-[10px] font-bold uppercase transition-colors flex items-center gap-1 ${sort_config.key === 'name' ? 'bg-blue-500/20 text-blue-400' : 'bg-zinc-800 text-zinc-500 hover:bg-zinc-700'}`}
                        >
                        ...
                        <button 
                            ...
                            className={`px-3 py-1 rounded text-[10px] font-bold uppercase transition-colors flex items-center gap-1 ${sort_config.key === 'status' ? 'bg-blue-500/20 text-blue-400' : 'bg-zinc-800 text-zinc-500 hover:bg-zinc-700'}`}
                        >
                        ...
                        <button 
                            ...
                            className={`px-3 py-1 rounded text-[10px] font-bold uppercase transition-colors flex items-center gap-1 ${sort_config.key === 'quota' ? 'bg-blue-500/20 text-blue-400' : 'bg-zinc-800 text-zinc-500 hover:bg-zinc-700'}`}
                        >
                            ...
                            <div key={q.entity_id} className={`p-4 rounded-xl border flex flex-col gap-4 ${is_exceeded ? 'bg-red-500/5 border-red-500/30' : 'bg-zinc-950/50 border-zinc-800'}`}>
                                ...
                                <div className="space-y-2">
                                    <div className="h-1.5 bg-zinc-900 rounded-full overflow-hidden border border-zinc-800">
                                        <div 
                                            className={`h-full transition-all duration-500 ${is_exceeded ? 'bg-red-500' : (q.used_usd/q.budget_usd > 0.8 ? 'bg-amber-500' : 'bg-blue-500')}`}
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-zinc-950 p-4 rounded-xl border border-zinc-800">
                                <div className="flex justify-between items-center mb-1">
                                    ...
                                    <span className={`text-[10px] font-mono ${quotas_state?.system_defense.sandbox_status === 'ACTIVE' ? 'text-blue-500' : 'text-amber-500'}`}>
                                        {quotas_state?.system_defense.sandbox_type || 'Unknown'}
                                    </span>
                                </div>
                                <div className="h-1 bg-zinc-800 rounded-full">
                                    <div 
                                        className={`h-full ${quotas_state?.system_defense.sandbox_status === 'ACTIVE' ? 'bg-blue-500/30' : 'bg-amber-500/30'}`} 
