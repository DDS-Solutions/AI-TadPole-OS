        ...
        <div className="p-6 space-y-6 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filtered_catalog.map(model => (
                    <div key={model.id} className="bg-[color:var(--color-surface)]/40 border border-[color:var(--color-border)]/50 hover:border-green-500/30 rounded-2xl overflow-hidden flex flex-col transition-all group">
                        ...
                        <div className="p-4 bg-[color:color-mix(in_srgb,var(--color-background)_50%,transparent)] border-t border-[color:var(--color-border)]/50 space-y-3">
