        ...
        <div className="p-6 space-y-6 max-w-7xl mx-auto">
                ...
                <div className="space-y-4 flex-1">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-zinc-900/50 border border-zinc-800 rounded-xl pl-10 pr-4 py-3 text-zinc-100 focus:outline-none focus:border-blue-500 transition-colors"
                            value={filter}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filtered_catalog.map(model => (
                    <div key={model.id} className="bg-zinc-900/40 border border-zinc-800/50 hover:border-blue-500/30 rounded-2xl overflow-hidden flex flex-col transition-all group">
                        <div className="p-6 space-y-4 flex-1">
                            <div className="flex justify-between items-start">
                                <div className="space-y-1">
                                    <h3 className="text-lg font-bold text-zinc-100 group-hover:text-blue-400 transition-colors">{model.name}</h3>
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full p-2.5 rounded-xl border flex items-center justify-between transition-all group/btn ${
                                                ...
                                                : 'bg-zinc-900/50 border-zinc-800 text-zinc-400 hover:border-blue-500/40 hover:text-zinc-100'
                                            }`}
                                        >
                                            <div className="flex items-center gap-3">
                                                <Server size={14} className={status === 'idle' ? 'text-zinc-600 group-hover/btn:text-blue-500' : ''} />
