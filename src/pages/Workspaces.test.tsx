 ...
 * @aiContext
 * - Mocks useWorkspaceStore to control cluster and branch state.
    ...
    const mockAgents: Agent[] = [
        {
            ...
            model: 'test', status: 'idle', tokensUsed: 0
        },
        {
    ...
    const mockClusters = [
        {
            ...
            pendingTasks: [
                { id: 'task-1', description: 'Fix CSS', agentId: 'agent-2', timestamp: Date.now(), status: 'pending' },
                { id: 'task-2', description: 'Refactor JS', agentId: 'agent-1', timestamp: Date.now() - 10000, status: 'completed' }
            ]
        }
    ];
