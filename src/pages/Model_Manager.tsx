...
import { Model_Header_Actions } from '../components/model/Model_Header_Actions';
...
import { use_model_manager } from '../components/model/use_model_manager';
import {
    Vault_Lock_Screen,
    Provider_Grid,
...
export default function Model_Manager(): React.ReactElement {
    const { is_locked, lock } = use_vault_store();
    const { providers } = use_provider_store();
    const set_header_actions = use_header_store(s => s.set_actions);
    const clear_header_actions = use_header_store(s => s.clear_actions);
    ...
    useEffect(() => {
        ...
        return () => clear_header_actions();
    }, [is_locked, providers.length, lock, set_header_actions, clear_header_actions]);
