 ...
 * - **Subsystem**: UI Pages / Settings.test
 *
 ...
 * - **Witness Tests**: `Settings.test.tsx`
 */
...
vi.mock('../services/system_api_service', () => ({
    system_api_service: {
        oversight: {
            ...
            get_governance_settings: vi.fn().mockResolvedValue(null),
        },
    },
}));
...
describe('Settings Page', () => {
    ...
    beforeEach(() => {
        ...
        (system_api_service.oversight.update_governance_settings as Mock).mockResolvedValue({});
    });
    ...
    it('renders all settings sections', () => {
        ...
        expect(screen.getByText(/Model and Provider Defaults for Agent Use/i)).toBeInTheDocument();
    ...
    it('logs error when sync fails in handle_save', async () => {
        ...
        (system_api_service.oversight.update_governance_settings as Mock).mockRejectedValue(new Error('Network error'));
