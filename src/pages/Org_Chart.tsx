                ...
                <div className="min-w-max pt-1 pb-12 px-12 flex flex-col items-center gap-12 relative">
                    ...
                    <div className={`relative pt-0 mt-[-18px] w-[350px] ${dropdown_open_id === hierarchy_data.nexus?.id ? 'z-[100]' : 'z-20'}`}>
                        ...
                        >
                            ...
                            <path
                                d="M 500 0 V 20 Q 500 30 480 30 H 120 Q 100 30 100 40 V 52 M 500 20 V 52 M 500 20 Q 500 30 520 30 H 880 Q 900 30 900 40 V 52"
                                fill="none"
                            ...
                            <circle cx="100" cy="30" r="1.5" fill="rgba(113, 113, 122, 0.4)" />
                            <circle cx="500" cy="20" r="1.5" fill="rgba(113, 113, 122, 0.4)" />
                            <circle cx="900" cy="30" r="1.5" fill="rgba(113, 113, 122, 0.4)" />
                        </svg>
                    </div>
