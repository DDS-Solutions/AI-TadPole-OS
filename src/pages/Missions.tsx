...
export default function Missions() {
    ...
    const handle_run_mission = async () => {
        ...
        try {
            const { model_id, provider } = resolve_agent_model_config(alpha_agent as Agent);
                ...
                <div className="md:col-span-2 bg-zinc-950 border border-zinc-800 rounded-2xl flex flex-col overflow-hidden">
                    {active_cluster ? (
                            ...
                            <div className="p-6 flex flex-col gap-8 flex-1 overflow-y-auto custom-scrollbar">
                                ...
                                <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-xl">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-zinc-100 focus:outline-none focus:border-blue-500 transition-colors"
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
                            ...
                            />
                            <div className="mt-8 p-4 bg-blue-500/5 border border-blue-500/10 rounded-xl max-w-sm">
                                <p className="text-[10px] text-blue-400/60 uppercase font-bold tracking-widest mb-2">{i18n.t('missions.pro_tip')}</p>
