...
export default function Missions() {
    ...
    // Local objective state sync
    useEffect(() => {
        queueMicrotask(() => set_objective_input(active_cluster?.objective || ''));
    }, [active_cluster?.id, active_cluster?.objective]);
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            if (objective_input !== (active_cluster.objective || '')) {
                update_cluster_objective(active_cluster.id, objective_input);
            }
        }, 300);
