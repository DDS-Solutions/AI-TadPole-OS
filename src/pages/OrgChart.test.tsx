/**
 * @file OrgChart.test.tsx
 * @description Suite for the Agent Hierarchy (OrgChart) page.
 * @module Pages/OrgChart
 * @testedBehavior
 ...
 * @aiContext
 * - Mocking HierarchyNode and AgentConfigPanel to focus on layout logic.
 */
import { describe, it, expect, vi, beforeEach } from 'vitest';
import { render, screen, fireEvent, waitFor, act } from '@testing-library/react';
import OrgChart from './OrgChart';
import { agents as mockAgentsData } from '../data/mockAgents';
...
vi.mock('../components/HierarchyNode', () => ({
    HierarchyNode: (props: any) => (
        <div data-testid={`node-${props.agent?.id}`} data-theme={props.themeColor}>
...
describe('OrgChart', () => {
    ...
    it('updates agents when socket event is received', async () => {
        ...
        vi.mocked(TadpoleOSSocket.subscribeAgentUpdates).mockImplementation((cb) => {
            updateCallback = cb;
            return () => {};
        });
