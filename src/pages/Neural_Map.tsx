...
export default function Neural_Map(): React.ReactElement {
    return (
        <div className="h-full flex flex-col gap-6 p-6 overflow-y-auto">
            ...
            <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between shrink-0">
                <div>
                    ...
                    <p className="text-xs text-zinc-400 mt-1 max-w-2xl leading-relaxed">
                        Interactive topology graph illustrating the functional hierarchy and references of the Tadpole OS codebase.
            ...
            {/* Main graph panel */}
            <div className="flex-1 min-h-[600px] border border-zinc-800/80 bg-zinc-950/20 rounded-2xl relative overflow-hidden shadow-2xl">
                <KnowledgeGraph />
            </div>
        </div>
    );
