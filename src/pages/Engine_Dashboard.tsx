...
export default function Engine_Dashboard() {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4">
                    {stats.map((stat) => (
                        ...
                        <div className="p-5 border border-[color:var(--color-border)] rounded-2xl bg-[color:var(--color-surface)]/50 backdrop-blur-xl group hover:border-zinc-700 transition-all shadow-lg cursor-help">
                            ...
                            <div className="mt-3 flex items-center gap-1.5">
                                <div className={`h-1 w-full rounded-full bg-zinc-800 overflow-hidden`}>
                                    <div
                                        ...
                                        style={{ 
                                            width: stat.label === i18n.t('engine_dashboard.label_cpu') 
                                                ? `${cpu}%` 
                                                : stat.label === i18n.t('engine_dashboard.label_memory') 
                                                ? `${(memory / max_memory) * 100}%` 
                                                : `${Math.min((latency / 500) * 100, 100)}%` 
                                        }}
                                    />
                                </div>
                            </div>
            ...
            <div className="border border-[color:var(--color-border)] rounded-3xl bg-[color:var(--color-background)] relative overflow-hidden group shadow-2xl h-[500px]">
