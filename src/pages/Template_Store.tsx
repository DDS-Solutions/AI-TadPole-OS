        ...
        <div className="p-6 space-y-6 max-w-7xl mx-auto w-full">
            ...
            <div className="flex items-center gap-3 border-b border-[color:var(--color-border)]/50 pb-4">
                ...
                >
                    ...
                    <span>{i18n.t('template_store.tab_marketplace', { defaultValue: 'Swarm Marketplace' })}</span>
                ...
                >
                    ...
                    <span>{i18n.t('template_store.tab_installed', { defaultValue: 'Installed Swarms' })}</span>
                    <span className={`px-2 py-0.5 rounded text-[10px] font-mono ${
