...
import { Search, Download, ShieldCheck, Filter, Store, Star, Clock, AlertTriangle, ArrowLeft, Code, X, RefreshCw, ExternalLink } from 'lucide-react';
...
function Template_Store() {
    ...
    return (
        <div className="p-6 space-y-6 max-w-7xl mx-auto h-full flex flex-col w-full">
            {/* Header */}
                    ...
                    <>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {filteredTemplates.map(template => (
                                <div key={template.id} className="sovereign-card flex flex-col hover:border-green-500/30 transition-all duration-300 group hover:-translate-y-1 hover:shadow-2xl hover:shadow-green-500/5">
