 ...
 * - **Subsystem**: Frontend React Hooks / useLayoutServices
 * - **Primary Entrypoints**: `useLayoutServices`
 *
...
export function useLayoutServices() {
    ...
    useEffect(() => {
        ...
        const unsubscribe_pulse = get_tadpole_os_socket().subscribe_pulse((pulse) => {
