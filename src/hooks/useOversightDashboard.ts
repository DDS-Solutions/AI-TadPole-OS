...
export function useOversightDashboard(): UseOversightDashboardHook {
    ...
    const fetch_pending = useCallback(async () => {
        ...
        try {
            ...
            console.debug('[OversightDashboard] Failed to fetch pending oversight, using mock data:', err);
    ...
    const fetch_ledger = useCallback(async () => {
        ...
        try {
            ...
            console.debug('[OversightDashboard] Failed to fetch ledger, using mock data:', err);
            if (!has_attempted_fetch) {
