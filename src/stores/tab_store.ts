        ...
        }),
        {
            ...
            migrate: (persisted_state: unknown, version: number) => {
                ...
                if (version === 1) {
                    return {
                        ...state,
                        active_tab_id: state.active_tab_id || state.active_tab_id,
                        is_system_log_detached: state.isSystemLogDetached || state.is_system_log_detached,
                        is_trace_stream_detached: state.isTraceStreamDetached || state.is_trace_stream_detached,
                        is_lineage_stream_detached: state.isLineageStreamDetached || state.is_lineage_stream_detached
                    };
                }
                return state;
            }
