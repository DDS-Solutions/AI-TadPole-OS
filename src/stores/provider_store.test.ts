...
describe('use_provider_store', () => {
    ...
    describe('Provider CRUD', () => {
        ...
        it('logs error on add_provider failure', async () => {
            ...
            expect(log_error).toHaveBeenCalledWith('ProviderService', 'Provider Creation Failed — Reverting state', expect.any(Error));
        });
        ...
        it('logs error on delete_provider failure', async () => {
            ...
            expect(log_error).toHaveBeenCalledWith('ProviderService', 'Deletion Failed — Reverting optimistic state', expect.any(Error));
        });
    });
