...
let active_sync_unsubscribe: (() => void) | null = null;
        ...
        (set, get) => ({
            ...
            resolve_user_question: async (question_id: string, answer: string) => {
                ...
                try {
                    ...
                    await system_api_service.oversight.decide_oversight(question_id, 'approved', answer);
                } catch (err) {
            ...
            initialize_sync_listeners: () => {
                if (active_sync_unsubscribe) {
                    return active_sync_unsubscribe;
                }
                ...
                const unsubscribe = () => {
                    ...
                    active_sync_unsubscribe = null;
                };
                active_sync_unsubscribe = unsubscribe;
                return unsubscribe;
            }
        }),
        {
