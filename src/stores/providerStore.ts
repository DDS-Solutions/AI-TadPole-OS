...
interface ProviderState {
    ...
    setProviderConfig: (id: string, apiKey: string, baseUrl?: string, externalId?: string, protocol?: ProviderConfig['protocol'], customHeaders?: Record<string, string>, audioModel?: string, persistToEngine?: boolean) => Promise<void>;
...
export const useProviderStore = create<ProviderState>()(
    persist(
        (set, get) => ({
            ...
            setProviderConfig: async (id, apiKey, baseUrl, externalId, protocol, customHeaders, audioModel, persistToEngine) => {
