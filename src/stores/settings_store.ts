...
const LEGACY_DEV_TOKENS = new Set([
    ...
    'my-secure-token-123',
    'tadpole-os-sidecar-default-2026', // Now deprecated/legacy
]);
            ...
            onRehydrateStorage: () => {
                return (hydrated_state, error) => {
                    ...
                    if (hydrated_state) {
                        ...
                        // Strip legacy or empty tokens. Do NOT auto-enroll into hardcoded defaults.
                        ...
                        if (!trimmed_token || trimmed_token === '' || LEGACY_DEV_TOKENS.has(trimmed_token)) {
                            console.warn('[SettingsStore] 🛡️ Legacy or empty token detected. Security policy requires a valid NEURAL_TOKEN.');
