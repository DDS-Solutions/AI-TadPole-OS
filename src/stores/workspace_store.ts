...
const DEFAULT_TEAM_PRESETS: Team_Cluster_Preset[] = [
    {
        ...
        collaborators: ['utility_security_auditor', 'security_specialist', 'audit_specialist']
    },
    {
        id: 'preset-eng-swarm',
        ...
        collaborators: ['coder', 'system_architect', 'auditor']
    },
    {
        ...
        collaborators: ['researcher', 'documentation_specialist', 'github-analyst']
    }
];
