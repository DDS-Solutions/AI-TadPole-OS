...
describe('use_dropdown_store', () => {
    ...
    it('close_dropdown() is a no-op when already closed, preserving state reference', () => {
        use_dropdown_store.getState().close_dropdown();
        const before = use_dropdown_store.getState();
        use_dropdown_store.getState().close_dropdown();
        const after = use_dropdown_store.getState();
