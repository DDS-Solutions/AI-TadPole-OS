...
export function resolve_provider(model_id: string): string {
    ...
    // 2. OpenRouter / Stealth Routing
    if (lower.includes('stealth') || lower.includes('openrouter') || lower.includes('oxalpha') || lower.includes('ox-alpha')) return 'openrouter';

    // 3. Core Provider Keywords
...
export function get_model_color(model_name: string): string {
    ...
    // OpenRouter / Stealth - Violet
    if (lower.includes('stealth') || lower.includes('openrouter') || lower.includes('oxalpha') || lower.includes('ox-alpha')) {
