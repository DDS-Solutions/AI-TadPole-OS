 ...
 * - **Subsystem**: UI Components / Hierarchy / Node_Mission
 * - **Primary Entrypoints**: `Node_Mission`
 *
    ...
    return (
        <div className="min-h-[26px] py-0.5 flex items-center justify-between z-20">
            {has_mission ? (
                ...
                <div className="text-[10px] font-bold px-2 py-0.5 rounded-md border border-[color:var(--color-border)]/30 bg-[color:var(--color-surface)]/5 text-zinc-600/50 flex items-center gap-1 italic">
