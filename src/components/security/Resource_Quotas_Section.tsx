 ...
 * - **Subsystem**: UI Components / Security / Resource_Quotas_Section
 * - **Primary Entrypoints**: `Resource_Quotas_Section`
 *
...
export function Resource_Quotas_Section({ 
    ...
    return (
        <div className="sovereign-panel p-0 flex flex-col overflow-hidden">
