 ...
 * - **Subsystem**: UI Components / Security / Agent_Health_Section
 * - **Primary Entrypoints**: `Agent_Health_Section`
 *
                ...
                <div className="flex items-center gap-2 flex-1 md:max-w-xs">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full bg-zinc-950/30 border border-zinc-800 rounded-lg py-1 pl-8 pr-3 text-[10px] text-zinc-300 focus:outline-none focus:border-amber-500/50 transition-colors"
                        />
                    </div>
                    <button
