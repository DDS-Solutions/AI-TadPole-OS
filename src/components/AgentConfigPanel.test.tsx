...
describe('AgentConfigPanel', () => {
    ...
    beforeEach(() => {
        ...
        (useCapabilitiesStore as unknown as ReturnType<typeof vi.fn>).mockImplementation((selector: (state: any) => any) => {
            const state = {
                skills: [{ name: 'bash' }],
        ...
        (TadpoleOSService.getSkills as unknown as ReturnType<typeof vi.fn>).mockResolvedValue([]);
    });
