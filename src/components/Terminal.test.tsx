 ...
 * - **Telemetry Link**: Search `[Terminal_test]` in observability traces.
 */
 ...
 * 
 * ### AI Assist Note
 * **Integrated verification of Terminal autocomplete UX**. 
 * Mocks `system_api_service` to validate cross-component update callbacks and file suggestion hydration.
 */
...
describe('Terminal Autocomplete UX', () => {
    ...
    it('displays file suggestions dropdown when typing @', async () => {
        ...
        await waitFor(() => {
            expect(system_api_service.get_workspace_files).toHaveBeenCalled();
        });
