 ...
 * - **Primary Entrypoints**: `Mcp_Secrets_Wizard_Modal`, `extractMcpPlaceholders`
 *
...
import { KeyRound, Lock, Eye, EyeOff, ShieldCheck, Check, ArrowRight, X } from 'lucide-react';
...
export function extractMcpPlaceholders(
    ...
    for (const [serverName, serverVal] of Object.entries(servers)) {
        ...
        if (env && typeof env === 'object') {
            for (const [_, envVal] of Object.entries(env)) {
