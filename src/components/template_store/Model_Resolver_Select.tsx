...
export function Model_Resolver_Select({
    ...
    const [customProvider, setCustomProvider] = useState(value.provider || 'ollama-cloud');
    const [customModelId, setCustomModelId] = useState(value.modelId || 'gemma4:31b-cloud');
    const providerSelectId = useId();
    const modelInputId = useId();

    const systemProvider = settings.default_provider || 'ollama-cloud';
    const systemModel = settings.default_model || 'gemma4:31b-cloud';
