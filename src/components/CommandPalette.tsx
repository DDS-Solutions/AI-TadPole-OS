...
export const CommandPalette: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }): React.ReactElement | null => {
    ...
    const staticItems: CommandItem[] = [
        ...
        { id: 'page-caps', title: i18n.t('command.skills_workflows'), description: i18n.t('command.capabilities_hub'), icon: Settings, category: 'Page', action: () => { navigate('/capabilities'); onClose(); } },
