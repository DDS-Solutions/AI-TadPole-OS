    ...
    return (
        <div className="w-full h-full bg-[color:var(--color-background)] rounded-[2rem] border border-[color:var(--color-surface)] overflow-hidden relative group">
            ...
            >
                ...
                <Controls className="bg-[color:color-mix(in_srgb,var(--color-surface)_80%,transparent)] backdrop-blur-md border-[color:var(--color-border)] rounded-xl overflow-hidden fill-white" />
                ...
                <Panel position="top-left" className="m-6 flex flex-col gap-3">
                    <div className="flex gap-2 items-center">
                        ...
                        <button 
                            onClick={clear_all}
                            className="bg-[color:var(--color-surface)]/60 backdrop-blur-xl border border-[color:var(--color-border)] rounded-xl px-4 py-2 text-[10px] font-bold text-zinc-500 uppercase tracking-widest hover:text-rose-400 hover:border-rose-900/50 hover:bg-[color:var(--color-surface)] transition-all"
