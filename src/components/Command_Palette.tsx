...
export const Command_Palette: React.FC<{ is_open: boolean; on_close: () => void }> = ({ is_open, on_close }): React.ReactElement | null => {
        ...
        const timeout = setTimeout(async (): Promise<void> => {
            ...
            try {
                ...
                if (data.status === 'success') {
                    const results = data.entries.map((m: any): Command_Item => ({
                        id: `mem-${m.id}`,
                        title: m.text,
    ...
    }, [is_open, all_items, selected_index, on_close]);
                ...
                <div className="fixed inset-0 z-[200] flex items-start justify-center pt-[15vh] px-4">
                    ...
                    >
                        <div className="p-4 border-b border-zinc-800 flex items-center gap-3">
                            <Search className={clsx("transition-colors", is_searching ? "text-blue-500 animate-pulse" : "text-zinc-500")} size={20} />
                            <input
                                ref={input_ref}
                                type="text"
                                value={query}
                                ...
                                return (
                                    ...
                                    >
                                        <div className={clsx(
                                            ...
                                            index === selected_index ? "bg-zinc-700 text-blue-400" : "bg-zinc-950 text-zinc-600"
                                        )}>
