...
interface Governance_Section_Props {
    budget_usd: number;
    requires_oversight: boolean;
    cost_usd: number;
    theme_color: string;
    on_update_governance: (field: 'budget_usd' | 'requires_oversight', value: number | boolean) => void;
}
 ...
 */
export function Governance_Section({ 
    budget_usd, 
    requires_oversight, 
    cost_usd, 
    theme_color, 
    on_update_governance 
}: Governance_Section_Props) {
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            >
                <div className="relative z-10 flex items-start justify-between gap-6">
                    ...
                    <button
                        onClick={() => on_update_governance('requires_oversight', !requires_oversight)}
                ...
                <div className="bg-zinc-900/30 border border-zinc-800/50 rounded-2xl p-6 space-y-4">
                    ...
                    <div className="flex items-end gap-2 group">
                        ...
                        <input
                            ...
                            step="0.01"
                            value={budget_usd}
                            onChange={(e) => on_update_governance('budget_usd', parseFloat(e.target.value) || 0)}
