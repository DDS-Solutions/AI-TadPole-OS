                        ...
                        <div className="relative group/role">
                            ...
                            >
                                {availableRoles.map(r => (
                                    <option key={r} value={r} className="bg-[color:var(--color-surface)]">{r.toUpperCase()}</option>
                                ))}
                            </select>
                        ...
                        <div className="relative group/dept">
                            ...
                            >
                                {Object.entries(i18n.t('common.departments', { returnObjects: true })).map(([key, label]) => (
                                    <option key={key} value={label as string} className="bg-[color:var(--color-surface)]">{String(label).toUpperCase()}</option>
                                ))}
                            </select>
