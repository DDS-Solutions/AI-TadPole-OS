...
interface VoiceSectionProps {
    voice: {
        voiceId: string;
        voiceEngine: Agent_Voice_Engine;
    };
    sttEngine: Agent_Stt_Engine;
    themeColor: string;
    onUpdateVoice: (field: 'voice_id' | 'voice_engine' | 'stt_engine', value: string) => void;
}
                ...
                >
                    <div className="space-y-1.5">
                        ...
                        <select
                            ...
                            onChange={(e) => onUpdateVoice('voice_engine', e.target.value)}
                    ...
                    <div className="space-y-1.5">
                        ...
                        {voice.voiceEngine === 'openai' ? (
                            <select
                                value={voice.voiceId}
                                onChange={(e) => onUpdateVoice('voice_id', e.target.value)}
                                className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-zinc-200 focus:outline-none focus:border-zinc-700 appearance-none font-bold cursor-pointer"
                            >
                ...
                >
                    <div className="space-y-1.5">
                        ...
                        <select
                            ...
                            onChange={(e) => onUpdateVoice('stt_engine', e.target.value)}
                            className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-zinc-200 focus:outline-none focus:border-zinc-700 appearance-none font-bold cursor-pointer"
                        >
