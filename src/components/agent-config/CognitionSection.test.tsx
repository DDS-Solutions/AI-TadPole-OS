 ...
 * - **Subsystem**: UI Components / Agent-Config / CognitionSection.test
 *
...
describe('CognitionSection Component', () => {
    ...
    it('renders slot navigation tabs and handles tab changes', () => {
        ...
        // Verify slot buttons render with functional labels and slot badges
        ...
        expect(screen.getByText('Fast Tool & Swarm')).toBeInTheDocument();

        expect(screen.getByText('SLOT 3')).toBeInTheDocument();
        expect(screen.getByText('PLANNING')).toBeInTheDocument();
        expect(screen.getByText('Deep Reasoning & Audit')).toBeInTheDocument();
