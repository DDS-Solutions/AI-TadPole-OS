 ...
 * 
 * ### AI Assist Note
 * **UI Component**: Modal manager for swarm Departments.
 * Handles department creation, renaming, and deletion.
 * 
 * ### 🔍 Debugging & Observability
 * - **Failure Path**: Failed store updates or duplicate department validations.
 * - **Telemetry Link**: Search `[DepartmentManagerModal]` in UI logs.
 */
                ...
                >
                                ...
                                <div key={d} className="flex items-center justify-between gap-2 p-3 bg-zinc-900/20 rounded-xl border border-zinc-800/40">
                                    {isEditing ? (
                                        <input
                                            ...
                                            className="bg-black/45 border border-zinc-700 rounded px-2.5 py-1 text-xs text-zinc-200 focus:outline-none focus:border-green-500/50 flex-1"
                                        />
                                    ) : (
                    ...
                    <div className="p-5 border-t border-zinc-800 bg-zinc-900/30 flex gap-2">
                        <input
                            ...
                            className="bg-black/30 border border-zinc-800 rounded-xl px-3.5 py-2 text-xs text-zinc-200 focus:outline-none focus:border-green-500/50 flex-1"
                        />
                        <button
...
// Metadata: [DepartmentManagerModal]
