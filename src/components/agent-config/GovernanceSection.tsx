...
export function GovernanceSection({ 
    ...
    const [localBudget, setLocalBudget] = useState(budgetUsd.toString());
    const [prevBudgetUsd, setPrevBudgetUsd] = useState(budgetUsd);

    if (budgetUsd !== prevBudgetUsd) {
        setPrevBudgetUsd(budgetUsd);
        setLocalBudget(budgetUsd.toString());
    }
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            >
                <div className="relative z-10 flex items-start justify-between gap-6">
                    ...
                    <button
                        onClick={() => onUpdateGovernance('requires_oversight', !requiresOversight)}
                ...
                <div className="bg-zinc-900/30 border border-zinc-800/50 rounded-2xl p-6 space-y-4">
                    ...
                    <div className="flex items-end gap-2 group">
                        ...
                        <input
                            ...
                            onBlur={() => onUpdateGovernance('budget_usd', parseFloat(localBudget) || 0)}
