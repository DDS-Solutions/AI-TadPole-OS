 ...
 * - **Subsystem**: UI Components / Outward / useCatalogIngestion
 * - **Primary Entrypoints**: `useCatalogIngestion`, `QbItem`, `UseCatalogIngestionOptions`, `IngestionType`
 *
 ...
 * - **Local Errors**: none
 * - **Telemetry Targets**: `[useCatalogIngestion]`
