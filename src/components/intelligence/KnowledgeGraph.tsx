 ...
 * - **Subsystem**: UI Components / Intelligence / KnowledgeGraph
 * - **Primary Entrypoints**: `KnowledgeGraph`
 *
 ...
 * - **Local Errors**: none
 * - **Telemetry Targets**: `[GraphErrorBoundary]`
 */
            ...
            <div className="flex flex-col gap-2">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-xs font-black text-white uppercase tracking-[0.4em]">
                        {viewMode === 'okf'
                            ? i18n.t('knowledge_graph.title_okf')
                            : viewMode === 'memory'
                            ? i18n.t('knowledge_graph.title_memory')
                            : i18n.t('knowledge_graph.title_symbols')}
                    </h2>
                </div>
                <div className="flex items-center gap-4 ml-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest">
                            {data?.nodes.length || 0}{' '}
                            {viewMode === 'okf'
                                ? i18n.t('knowledge_graph.label_concepts')
                                : viewMode === 'memory'
                                ? i18n.t('knowledge_graph.label_docs')
                                : i18n.t('knowledge_graph.label_symbols')}
                        </span>
                    </div>
    ...
    return (
        <div className="absolute top-20 left-6 flex items-center gap-2 z-35 pointer-events-auto select-none">
            ...
            <div className="flex bg-zinc-900/80 border border-zinc-800 rounded-lg p-0.5 backdrop-blur-md">
                ...
                >
                    {i18n.t('knowledge_graph.btn_memory_mode')}
                </button>
                <button
