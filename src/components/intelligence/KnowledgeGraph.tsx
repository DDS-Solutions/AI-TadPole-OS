...
import type { ExtendedGraphNode, ForceGraphLink, GraphMethods } from './knowledge_graph/types';
...
import { sanitize_graph_data, type SanitizedGraphResult } from './knowledge_graph/graph_sanitizer';
import { PathFinderModal } from './knowledge_graph/PathFinderModal';

export const KnowledgeGraph: React.FC = () => {
    const fg_ref = useRef<GraphMethods | undefined>(undefined);
    const [data, set_data] = useState<SanitizedGraphResult['data'] | null>(null);
