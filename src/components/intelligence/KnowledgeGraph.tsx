            ...
            <div className="flex flex-col gap-2">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-xs font-black text-white uppercase tracking-[0.4em]">
                        {viewMode === 'okf' ? 'Semantic OKF Graph' : 'Codebase Symbols Graph'}
                    </h2>
                </div>
                <div className="flex items-center gap-4 ml-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest">
                            {data?.nodes.length || 0} {viewMode === 'okf' ? 'Concepts' : 'Symbols'}
                        </span>
                    </div>
...
const ViewportHUD: React.FC = () => {
    ...
    const { setIsPathFinderOpen, viewMode, setViewMode } = useUIStateContext();
                ...
                {viewMode === 'okf' ? (
                    <>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[8px] font-bold text-zinc-400 uppercase tracking-widest">Confirmed</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: '#f59e0b' }} />
                            <span className="text-[8px] font-bold text-zinc-400 uppercase tracking-widest">Expiring</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: '#ef4444' }} />
                            <span className="text-[8px] font-bold text-zinc-400 uppercase tracking-widest">Broken Link</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: '#71717a' }} />
                            <span className="text-[8px] font-bold text-zinc-400 uppercase tracking-widest">Base Node</span>
                        </div>
                    </>
                ) : (
                    <>
