 ...
 * - **Subsystem**: UI Components / Intelligence / TraceDetailPanel
 * - **Primary Entrypoints**: `Trace_Detail_Panel`, `LocalErrorBoundary`, `TraceDetailPanelProps`
 *
 ...
 * - **Local Errors**: none
 * - **Telemetry Targets**: `[LocalErrorBoundary]`
