 ...
 *
 * ### AI Assist Note
 * **Graph Data Fetching & Projection Hook**: Manages the full lifecycle
 * of fetching graph data (symbols or OKF entries), sanitizing it,
 * and projecting it into a force-graph-compatible structure.
 *
 * ### 🔍 Debugging & Observability
 * - **Failure Path**: Stale data after viewMode switch.
 * - **Telemetry Link**: Search `[useGraphData]` in component traces.
 */
