 ...
 * - **Subsystem**: UI Components / Intelligence / graph_render_config
 * - **Primary Entrypoints**: `COMMUNITY_COLORS`, `get_link_source_id`, `get_link_target_id`, `get_node_community`
 *
...
export const drawNode = (
    ...
    selectedNodeId: string | null,
    hoverNodeId: string | null,
    viewMode: 'symbols' | 'memory' | 'okf' = 'symbols'
): void => {
    ctx.save();
    if (viewMode === 'okf') {
