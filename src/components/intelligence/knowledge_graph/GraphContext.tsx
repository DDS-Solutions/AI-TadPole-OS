 ...
 * - **Subsystem**: UI Components / Intelligence / GraphContext
 * - **Primary Entrypoints**: `GraphDataProvider`, `SelectionProvider`, `NavigationProvider`, `ViewportProvider`
 *
...
export const GraphProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const uiStateValue = useMemo<UIStateContextType>(() => ({
        ...
        isAnomalyPanelOpen: nodeSelectionHook.isAnomalyPanelOpen,
        setIsAnomalyPanelOpen: nodeSelectionHook.setIsAnomalyPanelOpen,
        ...
        nodeSelectionHook.isAnomalyPanelOpen, nodeSelectionHook.setIsAnomalyPanelOpen,
