 ...
 * - **Subsystem**: UI Components / Intelligence / useNodeSelection
 * - **Primary Entrypoints**: `useNodeSelection`, `UseNodeSelectionParams`, `UseNodeSelectionResult`
 *
 ...
 * - **Local Errors**: none
 * - **Telemetry Targets**: `[useNodeSelection]`
 */
