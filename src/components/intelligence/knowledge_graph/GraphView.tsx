 ...
 * - **Subsystem**: UI Components / Intelligence / GraphView
 * - **Primary Entrypoints**: `GraphView`
 *
...
const ForceGraph2DComponent = ForceGraph2D as unknown as React.ComponentType<Record<string, unknown>>;
