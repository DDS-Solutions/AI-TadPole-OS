        ...
        <div className="flex flex-col gap-4 font-mono text-zinc-350">
            ...
            <div className="flex flex-col gap-2.5 text-[10px]">
                <div className="flex items-center justify-between py-1 border-b border-zinc-850/50">
                    <span className="text-zinc-500 uppercase text-[9px] font-bold">Topic Space</span>
                    <span className="text-zinc-300 font-bold truncate max-w-[200px]" title={node.path}>{node.path}</span>
                </div>

                <div className="flex items-center justify-between py-1 border-b border-zinc-850/50">
                    <span className="text-zinc-500 uppercase text-[9px] font-bold">Concept Type</span>
                ...
                <div className="flex items-center justify-between py-1 border-b border-zinc-850/50">
                    <span className="text-zinc-500 uppercase text-[9px] font-bold">Confidence Score</span>
                ...
                <div className="flex items-center justify-between py-1 border-b border-zinc-850/50">
                    <span className="text-zinc-500 uppercase text-[9px] font-bold">Governance State</span>
                ...
                {node.resource_uri && (
                    <div className="flex flex-col gap-1 py-1 border-b border-zinc-850/50">
                        <span className="text-zinc-500 uppercase text-[9px] font-bold mb-1">Resource Link</span>
                        <a 
                ...
                {node.tags && (
                    <div className="flex flex-col gap-1.5 py-1">
                        <span className="text-zinc-500 uppercase text-[9px] font-bold">Tags</span>
            ...
            {node.text && (
                <div className="flex flex-col gap-1.5 bg-zinc-950/50 border border-zinc-850/50 p-3 rounded-xl max-h-48 overflow-y-auto custom-scrollbar">
                    <span className="text-zinc-500 uppercase text-[8px] font-black tracking-widest mb-1">Cognition Content</span>
