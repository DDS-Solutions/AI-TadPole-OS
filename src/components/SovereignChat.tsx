                    ...
                    <div className="px-3 pb-2 flex items-center gap-2">
                        ...
                        <div className="relative flex-1 min-w-0">
                            <button
                                ...
                                className={clsx(
                                    ...
                                    activeScope === 'agent' ? "border-green-500/50 text-green-400" : "border-[color:var(--color-border)] text-zinc-500 hover:text-zinc-300"
                                )}
                        ...
                        <div className="relative flex-1 min-w-0">
                            <button
                                ...
                                className={clsx(
                                    "w-full flex items-center justify-between gap-2 text-[10px] font-bold transition-colors uppercase tracking-widest bg-[color:var(--color-surface)]/50 px-2 py-1.5 rounded border group",
                                    activeScope === 'cluster' ? "border-emerald-500/50 text-emerald-400" : "border-[color:var(--color-border)] text-zinc-500 hover:text-zinc-300"
                                )}
                                aria-haspopup="listbox"
