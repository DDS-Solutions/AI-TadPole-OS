            ...
            <div className="flex items-center justify-between w-full relative z-10 pointer-events-none">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Tooltip content={i18n.t('model_manager.grid.tooltip_configure')} position="top">
                        <button className="p-1.5 text-zinc-700 hover:text-emerald-400 transition-colors pointer-events-auto" aria-label={i18n.t('model_manager.grid.tooltip_configure')}>
                            <Sliders size={14} />
                        </button>
                    </Tooltip>
                </div>
