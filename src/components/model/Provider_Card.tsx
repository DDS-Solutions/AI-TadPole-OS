 ...
 * - **Subsystem**: UI Components / Model / Provider_Card
 * - **Primary Entrypoints**: `Provider_Card`
 *
...
export function Provider_Card({
    ...
    return (
        <div
            className={`group p-5 bg-[color:var(--color-surface)]/40 border rounded-2xl transition-all duration-300 relative overflow-hidden flex flex-col items-start gap-3 hover:border-emerald-500/40 hover:bg-emerald-500/[0.02] ${is_selected ? 'border-emerald-500 bg-emerald-500/5' : 'border-[color:var(--color-border)]'}`}
        >
            <button 
