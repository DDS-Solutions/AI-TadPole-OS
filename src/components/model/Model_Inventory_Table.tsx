 ...
 * - **Subsystem**: UI Components / Model / Model_Inventory_Table
 * - **Primary Entrypoints**: `Model_Inventory_Table`
 *
...
export function Model_Inventory_Table({
    ...
    return (
        <section className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Tooltip content={i18n.t('model_manager.inventory.tooltip_filter')} position="top">
                        <div className="flex items-center gap-1 bg-[color:var(--color-surface)] border border-[color:var(--color-border)] rounded-lg px-2 py-1 cursor-help">
            ...
            <div className="bg-[color:var(--color-surface)]/40 backdrop-blur-xl border border-[color:var(--color-border)] rounded-3xl overflow-hidden shadow-2xl relative">
                <table className="w-full text-left text-sm border-collapse">
                    <thead className="bg-[color:color-mix(in_srgb,var(--color-background)_80%,transparent)] backdrop-blur text-zinc-500 text-[9px] uppercase tracking-[0.2em] border-b border-[color:var(--color-border)]">
                        <tr>
