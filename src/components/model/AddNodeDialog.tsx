...
interface AddNodeDialogProps {
    ...
    onUpdateNewNode: (updates: Partial<AddNodeDialogProps['newNode']>) => void;
    onConfirm: () => void;
    onCancel: () => void;
    isCustomModality: boolean;
    onSetIsCustomModality: (val: boolean) => void;
    customModality: string;
    onSetCustomModality: (val: string) => void;
            ...
            <tr className="bg-blue-500/5 animate-in slide-in-from-top-2 duration-300">
                <td className="px-8 py-4">
                    ...
                    <input
                        ...
                        value={newNode.name}
                        onChange={e => onUpdateNewNode({ name: e.target.value })}
                    />
                </td>
                <td className="px-8 py-4">
                    <select
                        ...
                        onChange={e => {
                            if (e.target.value === 'other') {
                                onSetIsCustomModality(true);
                            } else {
                                onSetIsCustomModality(false);
                                onUpdateNewNode({ modality: e.target.value as ModelEntry['modality'] });
                            }
                        }}
                    >
                    ...
                    {isCustomModality && (
                        <input
                            ...
                            onChange={e => onSetCustomModality(e.target.value)}
                        />
                    )}
                </td>
                <td className="px-8 py-4">
                    <select
                        ...
                        onChange={e => onUpdateNewNode({ provider: e.target.value })}
                    >
                    ...
                    <div className="grid grid-cols-4 gap-8">
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                value={newNode.rpm}
                                onChange={e => onUpdateNewNode({ rpm: parseInt(e.target.value) || 0 })}
                            />
                        </div>
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full bg-zinc-950 border border-zinc-800 rounded px-2 py-1 text-xs text-zinc-400 font-mono focus:outline-none focus:border-blue-500/50"
                                value={newNode.tpm}
                                onChange={e => onUpdateNewNode({ tpm: parseInt(e.target.value) || 0 })}
                            />
                        </div>
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full bg-zinc-950 border border-zinc-800 rounded px-2 py-1 text-xs text-zinc-400 font-mono focus:outline-none focus:border-blue-500/50"
                                value={newNode.rpd}
                                onChange={e => onUpdateNewNode({ rpd: parseInt(e.target.value) || 0 })}
                            />
                        </div>
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full bg-zinc-950 border border-zinc-800 rounded px-2 py-1 text-xs text-zinc-400 font-mono focus:outline-none focus:border-blue-500/50"
                                value={newNode.tpd}
                                onChange={e => onUpdateNewNode({ tpd: parseInt(e.target.value) || 0 })}
                            />
                        </div>
                    </div>
                </td>
