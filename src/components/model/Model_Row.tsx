...
export function Model_Row({ 
    ...
    const [edit_prov, set_edit_prov] = useState(model.provider);
                ...
                <tr className="bg-blue-500/[0.03]">
                    ...
                    <td className="px-8 py-4">
                        <select
                            className="bg-zinc-950 border border-blue-500/30 rounded-lg px-3 py-1.5 text-[10px] text-zinc-400 w-full focus:outline-none cursor-pointer uppercase font-bold"
                            value={edit_prov}
                            onChange={e => set_edit_prov(e.target.value)}
                        >
                    ...
                    <td className="px-8 py-4 text-right">
                        <div className="flex items-center justify-end gap-3">
                            <button
                                onClick={() => {
                                    const final_modality = (is_custom_modality ? custom_modality : edit_modality) as Model_Entry['modality'];
                                    on_save(edit_name, edit_prov, final_modality, limits);
                                }}
