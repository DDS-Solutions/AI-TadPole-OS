 ...
 * - **Subsystem**: UI Components / Model / Add_Node_Dialog
 * - **Primary Entrypoints**: `Add_Node_Dialog`
 *
            ...
            <tr className="bg-green-500/5 animate-in slide-in-from-top-2 duration-300">
                ...
                <td className="px-8 py-4 text-right">
                    <div className="flex items-center justify-end gap-3">
                        ...
                        <button onClick={on_cancel} aria-label={i18n.t('common.cancel', { defaultValue: 'Cancel' })} className="p-1.5 bg-zinc-800 text-zinc-500 rounded hover:bg-zinc-700 transition-all"><X size={14} /></button>
                    </div>
                </td>
            </tr>
