 ...
 * - **Subsystem**: UI Components / Settings / Governance_Settings
 * - **Primary Entrypoints**: `Governance_Settings`
 *
                ...
                <div className="space-y-3 z-10 relative p-4 bg-[color:color-mix(in_srgb,var(--color-background)_50%,transparent)] rounded-lg border border-[color:var(--color-border)] group/shield">
                    <div className="flex items-center justify-between">
                        ...
                        <input
                            ...
                            disabled
                            className="w-5 h-5 rounded border-zinc-700 bg-zinc-800/80 text-green-500/50 cursor-not-allowed opacity-50"
                        />
                    </div>
                    ...
                    <p className="text-[10px] text-zinc-600 leading-normal mt-1">
                        ℹ️ This setting is determined by the <code className="px-1 py-0.5 bg-zinc-800/60 rounded text-zinc-400 font-mono text-[9px]">PRIVACY_MODE</code> variable in your <code className="px-1 py-0.5 bg-zinc-800/60 rounded text-zinc-400 font-mono text-[9px]">.env</code> file. To change it, update the value and restart the backend server.
                    </p>
                    {settings.privacy_mode && (
