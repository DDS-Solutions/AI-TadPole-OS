 ...
 * - **Subsystem**: UI Components / Settings / Agent_Defaults_Settings
 * - **Primary Entrypoints**: `Agent_Defaults_Settings`
 *
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-[color:var(--color-surface)] py-8 pl-8 pr-32 rounded-xl border border-[color:var(--color-border)] shadow-sm relative overflow-hidden group">
                ...
                <div className="space-y-5 z-10 relative">
                    ...
                    <div className="space-y-2">
                        <Tooltip content={i18n.t('settings.tooltip_default_provider')} position="top">
                            <label htmlFor="default_provider" className="text-sm font-bold text-zinc-300 block cursor-help w-max">{i18n.t('settings.label_default_provider')}</label>
                        </Tooltip>
                        <select
                            id="default_provider"
                        ...
                        <p className="text-xs text-zinc-500 leading-relaxed">{i18n.t('settings.desc_default_provider')}</p>
                    </div>
                </div>
