 ...
 * - **Subsystem**: UI Components / Provider / Identity_Header
 * - **Primary Entrypoints**: `Identity_Header`
 *
            ...
            <div className="flex items-start gap-4 z-10">
                ...
                <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-[11px] text-zinc-500 font-mono tracking-tighter bg-[color:var(--color-surface)] border border-white/5 px-2 py-0.5 rounded">
                            {provider_id.toUpperCase()}
                        </span>
                    </div>
                </div>
            </div>
            <button onClick={on_close} aria-label={i18n.t('common.close', { defaultValue: 'Close' })} className="p-2 rounded-lg hover:bg-zinc-800 transition-colors text-zinc-500 hover:text-white z-10">
                <X size={20} />
            </button>
        </div>
    );
