...
export const Params_Cell: React.FC<ParamsCellProps> = ({ params }) => {
            ...
            <button
                ...
                className={clsx(
                    ...
                    is_open 
                        ...
                        : "bg-black/30 hover:bg-black/50 text-zinc-400 border-zinc-800/50 hover:text-zinc-200"
                )}
                    ...
                    {show_box && (
                        ...
                        >
                            ...
                            <div className="relative">
                                <pre className="font-mono text-[11px] text-zinc-300 leading-relaxed overflow-auto custom-scrollbar p-2.5 bg-black/60 rounded-lg border border-zinc-800/60 max-h-64 whitespace-pre-wrap break-all select-text">
                                    {formatted_json}
                                </pre>
                            </div>
