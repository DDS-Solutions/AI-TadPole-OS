                            ...
                            <tr key={entry.id} className="hover:bg-zinc-800/20 transition-colors">
                                ...
                                <td className="p-3">
                                    {entry.decision === 'rejected' ? (
                                        ...
                                        // No result written back yet — tool was approved and dispatched.
                                        // The backend does not currently persist execution outcomes to oversight_log.
                                        <span className="text-amber-400 text-xs uppercase font-bold tracking-wider">
                                            {entry.decision === 'approved' ? i18n.t('oversight.approved_label') : '—'}
                                        </span>
                                    ) : (
                                        <span className={`text-xs font-bold uppercase tracking-wider ${entry.result?.success ? 'text-green-400' : 'text-red-400'}`}>
