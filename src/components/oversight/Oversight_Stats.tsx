 ...
 * - **Subsystem**: UI Components / Oversight / Oversight_Stats
 * - **Primary Entrypoints**: `Oversight_Stats`
 *
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            <Tooltip content={i18n.t('oversight.pending_actions_tooltip')} position="top" class_name="w-full">
                <div className="bg-[color:var(--color-surface)] border border-[color:var(--color-border)] p-4 rounded-lg flex items-center justify-between cursor-help w-full">
                    <div>
                        <p className="text-zinc-400 text-xs font-mono uppercase tracking-wider">{i18n.t('oversight.pending_actions_label')}</p>
            ...
            <Tooltip content={i18n.t('oversight.approved_tooltip')} position="top" class_name="w-full">
                <div className="bg-[color:var(--color-surface)] border border-[color:var(--color-border)] p-4 rounded-lg flex items-center justify-between cursor-help w-full">
                    <div>
                        <p className="text-zinc-400 text-xs font-mono uppercase tracking-wider">{i18n.t('oversight.approved_label')}</p>
            ...
            <Tooltip content={i18n.t('oversight.rejected_tooltip')} position="top" class_name="w-full">
                <div className="bg-[color:var(--color-surface)] border border-[color:var(--color-border)] p-4 rounded-lg flex items-center justify-between cursor-help w-full">
                    <div>
                        <p className="text-zinc-400 text-xs font-mono uppercase tracking-wider">{i18n.t('oversight.rejected_label')}</p>
