                ...
                <div className="flex gap-4">
                    <Tooltip content={is_live ? i18n.t('standups.tooltip_end') : can_start_sync ? i18n.t('standups.tooltip_start') : i18n.t('standups.tooltip_no_target')} position="top">
                        <button
                            ...
                            className={`px-6 py-2 rounded-full font-bold flex items-center gap-2 transition-all disabled:cursor-not-allowed disabled:bg-zinc-800 disabled:text-zinc-500 ${is_live ? 'bg-red-500/10 text-red-500 hover:bg-red-500/20' : 'bg-emerald-500 text-black hover:bg-emerald-400'}`}>
