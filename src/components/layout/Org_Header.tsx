 ...
 * 
 * ### AI Assist Note
 * **UI Shell Component**: Primary organizational header for route titles, swarm telemetry, and system-wide toggles. 
 * Orchestrates real-time WebSocket connection state pulses and "Air Gap" privacy mode synchronization with the Rust engine.
 * 
 * ### 🔍 Debugging & Observability
 * - **Failure Path**: i18n translation key missing (shows raw key), WebSocket heartbeat timeout (ping stays grey), or `privacy_mode` sync failure with the Rust engine (fails silently in console).
 * - **Telemetry Link**: Search for `[Org_Header]` or `Swarm_Status_Header` in UI logs.
 */
