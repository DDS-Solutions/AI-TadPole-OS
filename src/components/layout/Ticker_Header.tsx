 ...
 * - **Subsystem**: UI Components / Layout / Ticker_Header
 * - **Primary Entrypoints**: `Ticker_Header`
 *
...
export const Ticker_Header: React.FC = React.memo(() => {
    ...
    const content = (
        <div className="inline-flex items-center gap-12 whitespace-nowrap flex-nowrap pr-12 select-none h-full">
            {metrics.map((m: SwarmMetric) => (
                <div key={m.label} className="inline-flex items-center gap-12 whitespace-nowrap flex-nowrap">
    ...
    return (
        <div className="w-full relative flex items-center overflow-hidden pointer-events-auto border-b border-[color:var(--color-border)]/80 bg-[color:var(--color-background)] h-8 shrink-0 z-20">
