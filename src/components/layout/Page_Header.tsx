...
export const Page_Header: React.FC<Page_Header_Props> = ({ 
    ...
    return (
        <div className="px-6 py-4 flex items-center justify-between border-b border-[color:var(--color-surface)] bg-[color:color-mix(in_srgb,var(--color-background)_50%,transparent)] backdrop-blur-md shrink-0">
