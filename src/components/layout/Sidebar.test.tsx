 ...
 * - Sub-navigation Integration: Verifies AssetNav and IntelligenceNav are correctly placed.
...
vi.mock('../IntelligenceNav', () => ({
    IntelligenceNav: () => <div data-testid="intelligence-nav" />
}));

vi.mock('../AssetNav', () => ({
    AssetNav: () => <div data-testid="asset-nav" />
}));
...
describe('Sidebar Component', () => {
    ...
    it('renders navigation links and core sections', () => {
        render(
            <MemoryRouter>
                <Sidebar navItemClass={mockNavItemClass} />
            </MemoryRouter>
        );
