        ...
        <div className="flex-1 flex flex-col min-h-0 bg-zinc-950/40 backdrop-blur-xl">
            ...
            <div className="flex-1 overflow-hidden flex flex-col relative min-h-0">
                <div className="flex-1 overflow-y-auto custom-scrollbar min-h-0">
                    ...
                    {mainTab === 'governance' && (
                        <GovernanceSection
                            budgetUsd={governance.budget_usd}
                            requiresOversight={governance.requires_oversight}
                    ...
                    <div className="px-6 py-4 space-y-6 bg-zinc-900/20 border-t border-zinc-900 shrink-0">
                        <VoiceSection
                            voice={{
                                ...
                                voiceEngine: voice.voice_engine as Agent_Voice_Engine
                            }}
                            sttEngine={(voice.stt_engine as Agent_Stt_Engine) || 'groq'}
                            themeColor={ui.theme_color}
                            onUpdateVoice={(field, value) => dispatch({ type: 'UPDATE_VOICE', field: field as 'voice_id' | 'voice_engine' | 'stt_engine', value })}
                        />
                    </div>
                </div>
