                    ...
                    <div className="space-y-6 max-w-prose mx-auto">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <input 
                                    id="import-name"
                                    autoFocus
                                    className="w-full bg-black/40 border border-[color:var(--color-border)] rounded-xl p-3 text-sm text-zinc-200 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 transition-all leading-relaxed"
                            ...
                            {(type === 'skill' || type === 'hook') && (
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        id="import-exec"
                                        className="w-full bg-black/40 border border-[color:var(--color-border)] rounded-xl p-3 text-sm text-zinc-200 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 transition-all font-mono leading-relaxed"
                        ...
                        {(type === 'skill' || type === 'hook') && (
                            <div className="space-y-2">
                                ...
                                <textarea 
                                    id="import-desc"
                                    className="w-full bg-black/40 border border-[color:var(--color-border)] rounded-xl p-3 text-sm text-zinc-300 min-h-[100px] focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 transition-all leading-relaxed"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <pre className="w-full bg-black/60 border border-[color:var(--color-border)] rounded-xl p-5 text-[11px] text-zinc-400 font-mono overflow-auto max-h-[300px] scrollbar-thin scrollbar-thumb-zinc-800 leading-normal">
                                    {preview}
                                </pre>
