 ...
 * - **Subsystem**: UI Components / Skills / Import_Preview_Modal
 * - **Primary Entrypoints**: `Import_Preview_Modal`
 *
...
export const Import_Preview_Modal: React.FC<Import_Preview_Modal_Props> = ({
    ...
    return (
        <div 
            className="fixed inset-0 z-[10000] flex items-center justify-center bg-zinc-950/60 backdrop-blur-sm animate-in fade-in duration-200"
            ...
            tabIndex={-1}
        >
            <div className="bg-[color:var(--color-surface)] border border-[color:var(--color-border)] rounded-xl shadow-2xl w-[95%] max-w-2xl max-h-[85vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
                {/* Header */}
                <div className="px-6 py-4 border-b border-[color:var(--color-border)] flex justify-between items-center bg-[color:var(--color-surface)]/50 backdrop-blur-xl">
                    <div>
                ...
                <div className="p-6 overflow-y-auto space-y-6 flex-1 scrollbar-thin scrollbar-thumb-zinc-800">
                    ...
                    <div className="space-y-3 p-4 bg-[color:color-mix(in_srgb,var(--color-background)_50%,transparent)] border border-[color:var(--color-border)] rounded-xl max-w-prose mx-auto">
                        ...
                        <div className="flex gap-3">
                            <button 
                                ...
                                className={`flex-1 min-h-[52px] px-4 py-3 rounded-xl border text-xs font-bold transition-all flex flex-col items-center justify-center gap-1 ${
                                    ...
                                    : 'bg-[color:var(--color-surface)]/50 border-[color:var(--color-border)] text-zinc-500 hover:border-zinc-700'
                                }`}
                    ...
                    <div className="space-y-6 max-w-prose mx-auto">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <input 
                                    id="import-name"
                                    autoFocus
                                    className="w-full bg-zinc-950/40 border border-[color:var(--color-border)] rounded-xl p-3 text-sm text-zinc-200 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 transition-all leading-relaxed"
                            ...
                            {(type === 'skill' || type === 'hook') && (
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        id="import-exec"
                                        className="w-full bg-zinc-950/40 border border-[color:var(--color-border)] rounded-xl p-3 text-sm text-zinc-200 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 transition-all font-mono leading-relaxed"
                        ...
                        {(type === 'skill' || type === 'hook') && (
                            <div className="space-y-2">
                                ...
                                <textarea 
                                    id="import-desc"
                                    className="w-full bg-zinc-950/40 border border-[color:var(--color-border)] rounded-xl p-3 text-sm text-zinc-300 min-h-[100px] focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 transition-all leading-relaxed"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <pre className="w-full bg-zinc-950/60 border border-[color:var(--color-border)] rounded-xl p-5 text-[11px] text-zinc-400 font-mono overflow-auto max-h-[300px] scrollbar-thin scrollbar-thumb-zinc-800 leading-normal">
                                    {preview}
                                </pre>
                ...
                <div className="px-8 py-6 border-t border-[color:var(--color-border)] flex justify-end items-center gap-6 bg-[color:color-mix(in_srgb,var(--color-surface)_80%,transparent)] backdrop-blur-md">
                    <button 
                        onClick={on_close} 
