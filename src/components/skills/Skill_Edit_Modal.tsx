 ...
 * - **Subsystem**: UI Components / Skills / Skill_Edit_Modal
 * - **Primary Entrypoints**: `Skill_Edit_Modal`
 *
    ...
    return (
        <div className="fixed inset-0 z-50 bg-zinc-950/80 backdrop-blur-md flex items-center justify-center p-4">
            <div className="bg-[color:var(--color-background)] border border-[color:var(--color-border)] w-full max-w-2xl rounded-2xl shadow-2xl flex flex-col max-h-[90vh] relative overflow-hidden">
                ...
                <div className="p-6 overflow-y-auto space-y-5 custom-scrollbar relative z-10 bg-[color:color-mix(in_srgb,var(--color-background)_80%,transparent)]">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-[color:var(--color-surface)] border border-[color:var(--color-border)] rounded p-3 text-zinc-200 font-mono text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500/50 outline-none transition-all placeholder:text-zinc-700"
                            placeholder={i18n.t('chat.placeholder_skill_name')}
                        />
                    </div>
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full bg-[color:var(--color-surface)] border border-[color:var(--color-border)] rounded p-3 text-zinc-300 focus:border-green-500 focus:ring-1 focus:ring-green-500/50 outline-none transition-all resize-y min-h-[80px] text-sm placeholder:text-zinc-700"
                            placeholder={i18n.t('chat.placeholder_skill_desc')}
                        />
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-[color:var(--color-surface)] border border-[color:var(--color-border)] rounded p-3 text-emerald-400 font-mono text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500/50 outline-none transition-all placeholder:text-zinc-700"
                            placeholder={i18n.t('chat.placeholder_exec_cmd')}
                        />
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className={`w-full bg-[color:var(--color-surface)] border rounded p-3 font-mono text-xs focus:ring-1 outline-none transition-all resize-y min-h-[150px] custom-scrollbar ${schema_error ? 'border-red-500/50 text-red-400 focus:border-red-500 focus:ring-red-500/50' : 'border-[color:var(--color-border)] text-zinc-300 focus:border-green-500 focus:ring-green-500/50'}`}
                            spellCheck="false"
                        />
                    </div>
                </div>
                <div className="p-5 border-t border-[color:var(--color-border)] flex justify-end gap-3 shrink-0 relative z-10 bg-[color:var(--color-background)]/90 items-center">
