 ...
 * - **Subsystem**: UI Components / Skills / Assignment_Modal
 * - **Primary Entrypoints**: `Assignment_Modal`
 *
...
export const Assignment_Modal: React.FC<Assignment_Modal_Props> = ({
    ...
    return (
        <div className="fixed inset-0 z-[60] bg-zinc-950/80 backdrop-blur-md flex items-center justify-center p-4">
            <div className="bg-[color:var(--color-background)] border border-[color:var(--color-border)] w-full max-w-md rounded-2xl shadow-2xl flex flex-col relative overflow-hidden">
                ...
                <div className="p-6 space-y-4 relative z-10 bg-[color:color-mix(in_srgb,var(--color-background)_80%,transparent)]">
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center justify-between p-3 rounded-xl border transition-all ${
                                        is_assigned 
                                            ...
                                            : 'bg-[color:var(--color-surface)]/50 border-[color:var(--color-border)] text-zinc-400 hover:border-zinc-700'
                                    }`}
                                >
                ...
                <div className="p-6 border-t border-[color:var(--color-border)] bg-[color:var(--color-surface)]/50 flex justify-end">
                    <button 
                        onClick={on_close} 
