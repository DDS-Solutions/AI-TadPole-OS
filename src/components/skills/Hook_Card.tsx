 ...
 * - **Subsystem**: UI Components / Skills / Hook_Card
 * - **Primary Entrypoints**: `Hook_Card`
 *
...
export const Hook_Card: React.FC<Hook_Card_Props> = ({ hook, on_edit, on_delete, is_loading }) => {
    return (
        <div className="sovereign-card space-y-4 hover:border-zinc-700 transition-all group">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                            <span className="text-[10px] font-mono text-zinc-600 bg-[color:var(--color-background)] px-1.5 py-0.5 rounded border border-[color:var(--color-border)] uppercase">{hook.hook_type}</span>
                            {hook.active && (
            ...
            <div className="pt-2">
                ...
                <pre className="text-[10px] font-mono text-zinc-500 bg-zinc-950/40 p-2.5 rounded-lg border border-[color:var(--color-border)]/50 truncate">
