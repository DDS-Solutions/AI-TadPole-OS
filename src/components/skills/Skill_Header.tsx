 ...
 * - **Subsystem**: UI Components / Skills / Skill_Header
 * - **Primary Entrypoints**: `Skill_Header`
 *
...
export const Skill_Header: React.FC<Skill_Header_Props> = ({ stats, handlers, state }) => {
    return (
        <div className="flex items-center justify-between border-b border-[color:var(--color-surface)] pb-2 px-1 shrink-0">
            <div>
            ...
            <div className="flex items-center gap-4">
                <div className="flex items-center p-1 bg-[color:var(--color-surface)] rounded-lg border border-[color:var(--color-border)] self-center">
                    ...
                    >
                        ...
                        <span className={`px-1 rounded ${state.active_category === 'user' ? 'bg-zinc-950/20 text-white' : 'bg-zinc-800 text-zinc-600'}`}>
                    ...
                    >
                        ...
                        <span className={`px-1 rounded ${state.active_category === 'ai' ? 'bg-zinc-950/20 text-white' : 'bg-zinc-800 text-zinc-600'}`}>
                ...
                <div className="flex items-center gap-2">
                    <Tooltip content={i18n.t('skills.tooltip_import')} position="bottom">
                        <button
                            ...
                            className="bg-[color:var(--color-surface)] hover:bg-zinc-800 border border-[color:var(--color-border)] text-zinc-400 hover:text-zinc-100 px-3 py-1.5 rounded-lg text-[10px] uppercase tracking-widest font-bold flex items-center gap-2 transition-all hover:border-green-500/50"
                        >
                ...
                <div className="relative">
                    <input
                        ...
                        className="bg-[color:var(--color-surface)] border border-[color:var(--color-border)] rounded-lg pl-8 pr-3 py-1.5 text-xs text-zinc-200 focus:outline-none focus:border-green-500/50 w-48 transition-all"
                    />
