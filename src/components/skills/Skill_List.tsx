...
export const Skill_List: React.FC<Skill_List_Props> = ({
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center mb-6 sticky top-0 bg-[color:color-mix(in_srgb,var(--color-background)_80%,transparent)] backdrop-blur-md pt-2 pb-3 border-b border-[color:var(--color-border)]/50 z-20">
