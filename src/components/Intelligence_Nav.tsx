...
export const Intelligence_Nav: React.FC<IntelligenceNavProps> = ({ navItemClass }): React.ReactElement => {
    return (
        <div className="space-y-1">
            ...
            <Tooltip content={i18n.t('nav.skills_tooltip')} position="right">
                <NavLink to="/skills" className={(props) => navItemClass(props) + " ml-2 lg:ml-6 scale-95 opacity-90 border-l-2 border-emerald-500/20 pl-2 lg:pl-3"}>
                    <Settings size={16} />
