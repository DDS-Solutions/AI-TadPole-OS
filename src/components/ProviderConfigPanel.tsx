...
import { X, Save, Plus, Check, ShieldCheck, Globe, Key, Zap, Info, Cpu, Activity, AlertTriangle } from 'lucide-react';
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            <div className="space-y-1.5">
                                <div className="flex items-center justify-between px-1">
                                    <label className="text-[11px] font-bold text-zinc-600 uppercase tracking-widest flex items-center gap-2">
