        ...
        const unsubscribe = get_tadpole_os_socket().subscribe_swarm_pulse((pulse: Swarm_Pulse) => {
            ...
            set_graph_data(prev => {
                ...
                if (!has_structural_change) {
                    const prev_ids_set = new Set(prev_nodes.map(n => n.id));
                    has_structural_change = pulse.nodes.some(n => !prev_ids_set.has(n.id));
                }
        ...
        const unsubscribe_reasoning = (get_tadpole_os_socket() as Tadpole_OS_Socket_Client).subscribe_raw((raw_event: Record<string, unknown>) => {
            ...
            if (event.type === 'agent:reasoning_step') {
                ...
                set_logic_data(prev => {
                    ...
                    const updated_nodes = [...prev.nodes, new_node].slice(-200);
                    ...
                    const updated_links = [...(new_link ? [...prev.links, new_link] : prev.links)]
