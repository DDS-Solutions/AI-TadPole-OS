 ...
 * - **Subsystem**: UI Components / Chat / Chat_Header
 * - **Primary Entrypoints**: `Chat_Header`, `Chat_Header_Props`
 *
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3">
                ...
                <div className="relative bg-zinc-100 p-1.5 rounded-md text-zinc-950 shadow-lg">
