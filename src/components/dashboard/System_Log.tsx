    ...
    return (
        <div className={clsx(
            ...
            <Tooltip content={i18n.t('dashboard.log_tooltip')} position="left">
                <div className="relative z-10 p-3 border-b border-[color:var(--color-border)] bg-[color:color-mix(in_srgb,var(--color-background)_80%,transparent)] backdrop-blur-md flex items-center justify-between cursor-help">
