...
export const Operation_Tab_Header: React.FC<Operation_Tab_Header_Props> = ({
    ...
    return (
        <div className="sticky top-0 bg-[color:color-mix(in_srgb,var(--color-background)_80%,transparent)] backdrop-blur-md z-30 border-b border-[color:var(--color-border)]/50 flex items-center justify-between px-2">
