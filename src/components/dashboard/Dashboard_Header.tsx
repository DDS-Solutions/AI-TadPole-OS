            ...
            <div className="flex gap-3">
                <Tooltip content={i18n.t('dashboard.scan_network')} position="bottom">
                    <button
                        ...
                        className="flex items-center gap-2 px-3 py-2 bg-[color:var(--color-surface)] hover:bg-zinc-800 border border-[color:var(--color-border)] text-zinc-400 font-bold rounded-lg text-[10px] transition-all uppercase tracking-widest"
                    >
