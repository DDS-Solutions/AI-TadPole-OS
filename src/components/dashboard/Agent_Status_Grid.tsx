...
export const Agent_Status_Grid: React.FC<Agent_Status_Grid_Props> = ({
    ...
    const [active_tab_id, set_active_tab_id] = useState('global');
        ...
        <>
                            ...
                            <div className="text-center space-y-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm text-zinc-500 font-mono">
                                        {i18n.t('layout.link_established') || 'Neural Link Established'} :: {active_tab_id.toUpperCase()}
                                    </p>
                                </div>
                                <button 
            ...
            <AnimatePresence>
                {detached_tab_ids.map(tab_id => {
                    ...
                    const title = tab_id === 'global' ? 'Global Swarm View' : (cluster?.name || tab_id.toUpperCase());
