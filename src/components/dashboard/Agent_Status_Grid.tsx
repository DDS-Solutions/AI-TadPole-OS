                            ...
                            <div className="text-center space-y-4">
                                ...
                                <div className="flex items-center justify-center gap-2">
                                    <button 
                                        ...
                                        className="px-4 py-2 bg-zinc-100 text-black text-xs font-bold uppercase tracking-widest rounded-lg hover:bg-white transition-all shadow-lg active:scale-95 flex items-center gap-1.5"
                                    >
