 ...
 */
export const BurnRateChart = ({ currentBurn, height = 120 }: BurnRateChartProps) => {
        ...
        >
            ...
            <div className="absolute top-4 left-4 z-10 flex flex-col">
                ...
                <span className="text-lg font-mono font-bold text-blue-400">
                    ${currentBurn.toFixed(4)}<span className="text-[10px] text-zinc-600 ml-1">/min</span>
                </span>
            </div>
            ...
            >
                ...
                <motion.div
                    className="absolute inset-y-0 w-1 bg-blue-500/20 blur-sm"
                    animate={{
                        left: ['0%', '100%'],
                    }}
                    transition={{
