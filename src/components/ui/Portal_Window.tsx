...
export const PortalWindow: React.FC<Portal_Window_Props> = ({ 
    ...
    useEffect(() => {
        ...
        // FOUC-Free Style Synchronization logic
        const sync_styles = () => {
        ...
        // Dynamic initial background color matching active theme
    ...
    }, [window_name, url]); // Width and height handled in separate resize effect to prevent window restarts
