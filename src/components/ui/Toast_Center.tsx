 ...
 * - **Subsystem**: UI Components / Ui / Toast_Center
 * - **Primary Entrypoints**: `Toast_Center`
 *
    ...
    return (
        <motion.div
            ...
            className={cn(
                ...
                "bg-zinc-950/60 backdrop-blur-xl border rounded-xl shadow-2xl overflow-hidden",
        ...
        >
            ...
            <button
                ...
                title={notification.persistent ? i18n.t('common.manual_dismiss') : i18n.t('common.close')}
            >
                <X className="w-4 h-4" />
            </button>
