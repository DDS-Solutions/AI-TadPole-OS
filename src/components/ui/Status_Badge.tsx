 ...
 * Maps system states (Active, Thinking, Error, etc.) to deterministic color tokens and pulse animations (2s duration).
 * 
 * ### 🔍 Debugging & Observability
 * - **Failure Path**: Unknown status state (falls back to idle), animation clock desync, or z-index occlusion in tooltips.
 * - **Telemetry Link**: Search for `[Status_Badge]` or `STATUS_COLORS` in UI tracing.
 */
