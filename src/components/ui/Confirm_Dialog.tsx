 ...
 * - **Subsystem**: UI Components / Ui / Confirm_Dialog
 * - **Primary Entrypoints**: `Confirm_Dialog`
 *
...
export const Confirm_Dialog: React.FC<Confirm_Dialog_Props> = ({
    ...
    return createPortal(
        <div
            className="fixed inset-0 flex items-center justify-center bg-zinc-950/60 backdrop-blur-sm animate-in fade-in duration-200"
        ...
        >
            <div
                ...
                className="sovereign-card max-w-[420px] w-[90%] shadow-2xl animate-in zoom-in-95 slide-in-from-bottom-4 duration-300"
            >
