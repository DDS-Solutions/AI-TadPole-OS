                ...
                <AnimatePresence>
                    {is_visible && (
                        <motion.div
                            ...
                            className="px-2.5 py-1.5 bg-[color:var(--color-surface)]/90 backdrop-blur-md border border-zinc-500/20 rounded-lg text-[10px] font-bold text-zinc-100 uppercase tracking-widest shadow-2xl whitespace-nowrap"
                        >
