 ...
 * - **Subsystem**: UI Components / Ui / Tooltip
 * - **Primary Entrypoints**: `Tooltip`
 *
                ...
                <AnimatePresence>
                    {is_visible && (
                        <motion.div
                            ...
                            className={clsx(
                                "px-2.5 py-1.5 bg-[color:var(--color-surface)]/95 backdrop-blur-md border border-zinc-500/20 rounded-lg text-[10px] font-bold text-zinc-100 uppercase tracking-widest shadow-2xl",
