...
describe('Portal_Window', () => {
    ...
    it('opens a new window on mount', () => {
        render(
            <Portal_Window id="test-tab" title="Test Tab" onClose={mockOnClose}>
                <div>Content</div>
            </Portal_Window>
        );
    ...
    it('does NOT re-open the window if the onClose callback changes (strobe fix)', () => {
        ...
        rerender(
            <Portal_Window id="test-tab" title="Test Tab" onClose={() => {}}>
                <div>Content</div>
            </Portal_Window>
        );
    ...
    it('updates document title when title prop changes without re-opening window', () => {
        const { rerender } = render(
            <Portal_Window id="test-tab" title="Initial Title" onClose={mockOnClose}>
                <div>Content</div>
            </Portal_Window>
        );
        ...
        rerender(
            <Portal_Window id="test-tab" title="Updated Title" onClose={mockOnClose}>
                <div>Content</div>
            </Portal_Window>
        );
