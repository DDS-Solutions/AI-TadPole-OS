 ...
 * - **Subsystem**: UI Components / Missions / Neural_Map
...
export const Neural_Map: React.FC<Neural_Map_Props> = ({ cluster, agents, theme_color }) => {
    ...
    if (!alpha_agent) return (
        <div
            className="relative w-full bg-[color:var(--color-surface)]/40 rounded-xl border border-dashed border-zinc-700/50 flex items-center justify-center mb-6"
    ...
    return (
        <div
            className="relative w-full bg-[color:var(--color-background)]/60 rounded-xl border border-[color:var(--color-border)]/50 mb-6 overflow-hidden"
            style={{ height: '192px', minHeight: '192px' }}
        >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                <motion.div
                    ...
                    className="w-14 h-14 rounded-full border-2 flex items-center justify-center bg-[color:var(--color-background)]"
                ...
                return (
                    ...
                    >
                        <motion.div
                            ...
                            className="w-8 h-8 rounded-lg border flex items-center justify-center bg-[color:var(--color-surface)]/90 backdrop-blur-sm"
