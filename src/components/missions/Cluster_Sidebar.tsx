...
import { Plus, Zap, Trash2, Target, Shield } from 'lucide-react';
        ...
        <div className="md:col-span-1 flex flex-col gap-3 h-full min-h-0 overflow-hidden pr-2 pl-1">
            <div className="flex items-center justify-between px-2 shrink-0">
                ...
                <Tooltip content={i18n.t('missions.tooltip_create_cluster')} position="left">
                    <button
                        onClick={() => set_show_create_modal(prev => !prev)}
                                    ...
                                    <div className="flex flex-col gap-1 mt-2">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <div className="relative group/dept">
                                                <span className="text-[11px] px-1.5 py-0.5 rounded bg-[color:var(--color-surface)] border border-[color:var(--color-border)] text-zinc-500 font-mono uppercase group-hover/dept:text-zinc-300 group-hover/dept:border-zinc-700 transition-colors">
                                                    {cluster.department}
                                                </span>
