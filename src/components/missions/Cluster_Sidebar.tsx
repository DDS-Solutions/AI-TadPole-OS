                            ...
                            <div className="flex-1 space-y-1">
                                ...
                                >
                                    {Object.entries(i18n.t('common.departments', { returnObjects: true })).map(([key, label]) => (
                                        <option key={key} value={label as string} className="bg-zinc-950 text-zinc-300">{String(label)}</option>
                                    ))}
                                </select>
                            </div>
                            <button
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Tooltip content={i18n.t('missions.tooltip_treasury')} position="top">
                                            <div className="flex items-center gap-1.5 px-3 py-1 rounded bg-blue-500/10 border border-blue-500/20 hover:border-blue-500/40 transition-all cursor-text">
                                                <span className="text-xs text-blue-400 font-mono font-bold">{i18n.t('common_units.currency')}</span>
                                                <input
                                                    type="number"
                                                    step="0.01"
