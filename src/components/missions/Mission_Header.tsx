            ...
            <div className="flex items-center gap-3">
                <Tooltip content={i18n.t('missions.tooltip_run')} position="left">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-xl border ${theme.border} bg-[color:var(--color-surface)] ${theme.text} hover:scale-105 active:scale-95 transition-all font-bold uppercase tracking-tighter shadow-lg ${theme.glow} disabled:opacity-40 disabled:pointer-events-none`}
                    >
                        <Zap size={16} fill="currentColor" className={is_launching ? 'animate-spin' : ''} />
                ...
                <div className={`p-3 bg-[color:var(--color-surface)] rounded-xl border border-[color:var(--color-border)] ${theme.text}`}>
