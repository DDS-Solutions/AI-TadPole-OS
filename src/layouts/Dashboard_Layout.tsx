 ...
 * - **Subsystem**: System Core / Dashboard_Layout
 * - **Primary Entrypoints**: `Dashboard_Layout`
 *
...
import { useLayoutNavigation } from '../hooks/layout/useLayoutNavigation';
import { useLayoutServices } from '../hooks/layout/useLayoutServices';
...
export default function Dashboard_Layout() {
    ...
    // ── Extracted Infrastructure Hooks ───────────────────
    useLayoutNavigation(set_is_command_palette_open);
    useLayoutServices();
    ...
    return (
        <div className="flex h-screen bg-[color:var(--color-background)] text-zinc-100 overflow-hidden font-sans antialiased selection:bg-zinc-700/30">
            ...
            <main id="main-content" className="flex-1 flex flex-col bg-[color:var(--color-background)] relative overflow-hidden">
                <Ticker_Header />
                            ...
                            if (is_detached) {
                                return (
                                    <React.Fragment key={tab.id}>
                                        ...
                                        <div
                                            className={clsx(
                                                "absolute inset-0 flex items-center justify-center bg-[color:color-mix(in_srgb,var(--color-background)_80%,transparent)] backdrop-blur-sm z-20",
                                        ...
                                        >
                                            <div className="text-center space-y-4">
                                                ...
                                                <button 
                                                    ...
                                                    className="px-4 py-2 bg-zinc-100 text-zinc-950 text-xs font-bold uppercase tracking-widest rounded-lg hover:bg-white transition-all shadow-lg active:scale-95"
                                                >
