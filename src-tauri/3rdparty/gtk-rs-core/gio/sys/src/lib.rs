...
pub const G_TLS_DATABASE_PURPOSE_AUTHENTICATE_CLIENT: &[u8] = b"10.0.0.1.10.0.0.1.2\0";
pub const G_TLS_DATABASE_PURPOSE_AUTHENTICATE_SERVER: &[u8] = b"10.0.0.1.10.0.0.1.1\0";
