 ...
 * 
 * ### AI Assist Note
 * **UI Component**: Control manifold for global dashboard operations. 
 * Orchestrates "Neural Reset" (Purge), "Safe Mode" toggles, and new agent/proposal deployment sequences.
 * 
 * ### 🔍 Debugging & Observability
 * - **Failure Path**: Double-click race condition on "Purge", or setting sync failure if the Websocket is unstable.
 * - **Telemetry Link**: Search for `[Dashboard_Header_Actions]` or `clear_history` in browser logs.
 */
