 ...
 * 
 * ### AI Assist Note
 * **UI Component**: Control group for the Model Inventory sector. 
 * Orchestrates global model search, provider addition, and "Sync All" lifecycle triggers.
 * 
 * ### 🔍 Debugging & Observability
 * - **Failure Path**: Search debounce lag (UI flicker), or action group occlusion on smaller viewports.
 * - **Telemetry Link**: Search for `[Model_Header_Actions]` or `sync_all_models` in UI tracing.
 */
