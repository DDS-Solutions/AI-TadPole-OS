...
> - **Subsystem**: Documentation / resource_allocation
> - **Architecture**: `@docs ARCHITECTURE:Documentation`
> - **Failure Path**: Information drift, legacy terminology, or documentation mismatch.
> - **Observability**: Traceability via `execution/parity_guard.py` (`[resource_allocation]`)
...
2. **Audit Phase**: Governance hooks verify current `cost_usd` against the `budget_limit`. Use `query_financial_logs` or check your `working_memory` (neural config).
