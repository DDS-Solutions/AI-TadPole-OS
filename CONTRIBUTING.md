...
> - **Subsystem**: Documentation / CONTRIBUTING
> - **Architecture**: `@docs ARCHITECTURE:Documentation`
> - **Failure Path**: Information drift, legacy terminology, or documentation mismatch.
> - **Observability**: Traceability via `execution/parity_guard.py` (`[CONTRIBUTING]`)
...
3. **Pre-Submit Checklist**:
   ...
   - [ ] `npm run test` passes
   - [ ] **Verification Parity**: Run `python execution/verify_all.py` and ensure 100% parity pass.
   - [ ] **Parity Guard**: Run `python execution/parity_guard.py` to ensure security protocols are correctly reflected.
