...
- **Secret-Aware Redaction**: Synchronized with `scanner.rs` multi-tiered regex patterns.
- **Path Integrity**: Canonicalized absolute root locking enforced across all file-system tools.
- **Identity Integrity**: User/Mission IDs now part of the Merkle Chain seed.
