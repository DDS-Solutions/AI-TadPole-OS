...
//!
//! ### AI Assist Note
//! **Sovereign Safety**: By default, any tool not explicitly whitelisted 
//! (`Allow`) or guardrailed (`Prompt`) will trigger a manual user prompt. 
//! Agents should check `PermissionMode` before assuming a tool call will succeed.
