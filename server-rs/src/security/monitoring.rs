...
//!
//! ### AI Assist Note
//! **Sandbox Detection**: Isolation detection is heuristic-based (env vars, 
//! cgroups, mount points). Agents should be aware that under rootless-Podman 
//! or custom micro-VMs (Firecracker), `is_isolated` may return false despite 
