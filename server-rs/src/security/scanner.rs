...
//!
//! ### AI Assist Note
//! **Command Injection False Positives**: The scanner is highly aggressive 
//! toward shell meta-characters (`;`, `&&`, `|`, `>`). Legitimate scripts 
//! involving piping or redirection WILL be flagged as `Risky`. Agents should 
//! verify the `ScannerResult` and suggest manual user approval if needed.
