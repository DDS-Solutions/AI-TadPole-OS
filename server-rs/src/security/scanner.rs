...
mod tests {
    ...
    fn test_scanner_evasion() {
        ...
        let obfuscated_openai = format!("sk-{}", "123456789012345678901234567890123456789012345678");
        // "еxport" uses Cyrillic 'е'
        match scanner.scan(&format!("\u{0435}xport OPENAI_API_KEY={}", obfuscated_openai)) {
            ScannerResult::Risky(r) => {
                assert!(r.contains("export") || r.contains("OpenAI") || r.contains("environment secret"), "Reason was: {}", r);
            }
