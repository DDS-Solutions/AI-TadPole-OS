...
//!
//! ### AI Assist Note
//! **Buffering & Consistency**: Consumption is stored in thread-safe buffers 
//! (`buffer`, `mission_buffer`) and flushed to SQLite asynchronously via `flush_to_db`. 
//! Agents should not assume immediate DB consistency for usage metrics.
