...
pub struct ModelConfig {
    ...
    #[serde(default, rename = "extraParameters")]
...
impl ModelConfig {
    ...
    pub fn merge(&self, other: &Self) -> Self {
        ...
        if merged.system_prompt.is_none() { merged.system_prompt = other.system_prompt.clone(); }
        if merged.temperature.is_none() { merged.temperature = other.temperature; }
        if merged.max_tokens.is_none() { merged.max_tokens = other.max_tokens; }
        if merged.rpm.is_none() { merged.rpm = other.rpm; }
        if merged.rpd.is_none() { merged.rpd = other.rpd; }
        if merged.tpm.is_none() { merged.tpm = other.tpm; }
        if merged.tpd.is_none() { merged.tpd = other.tpd; }
...
pub struct ProviderConfig {
    ...
    #[serde(default, rename = "defaultConfig")]
...
impl ProviderConfig {
    ...
    pub fn validate(&self) -> Result<(), String> {
        ...
        let valid_protocols = [
            "openai", "anthropic", "google", "ollama", "groq", "deepseek", "xai", "inception",
        ];
