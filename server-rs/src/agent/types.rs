...
//! Features **Model Config Guardrails** to handle provider-specific
//! nuances such as `supports_native_tools()` and **TPM/RPM Throttling**
//! metadata.
//!
...
struct EngineAgentResponse<'a> {
    ...
    #[serde(rename = "model2", skip_serializing_if = "Option::is_none")]
    model_2: &'a Option<String>,
    #[serde(rename = "model3", skip_serializing_if = "Option::is_none")]
    ...
    failure_count: u32,
    #[serde(skip_serializing_if = "Option::is_none")]
    last_failure_at: &'a Option<chrono::DateTime<chrono::Utc>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    created_at: &'a Option<chrono::DateTime<chrono::Utc>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    last_pulse: &'a Option<chrono::DateTime<chrono::Utc>>,
...
struct EngineAgentWire {
    ...
    #[serde(default, alias = "modelConfig2")]
    model_config2: Option<ModelConfig>,
    #[serde(default, alias = "modelConfig3")]
    ...
    last_pulse: Option<chrono::DateTime<chrono::Utc>>,
