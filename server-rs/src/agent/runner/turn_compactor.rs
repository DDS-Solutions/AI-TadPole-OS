//! Turn Compaction & Transcript Filtering Module
//!
//! Provides linear-time transcript filtering, message truncation, and context window
//! compaction algorithms for active agent runners.
//!
//! ### AI Assist Note
//! **Transcript Compactor**: Compacts agent turns to prevent context window explosion.
//!
//! ### 🔍 Debugging & Observability
//! - **Failure Path**: Transcript desynchronization or excessive context truncation.
//! - **Telemetry Link**: Search `[compactor]` in tracing logs.

/// Filters and cleans raw conversation history to produce a sandboxed visible transcript.
///
/// Removes private/internal event markers based on agent role authority and truncates
/// excessive tool outputs to prevent context window explosion.
