...
//! - `[Behavioral]` Tool outputs cached by (tool, args, root) are invalidated on file mtime modification or explicit path invalidation (enforced_by: `test_shared_tool_cache_mtime_invalidation`, `test_shared_tool_cache_invalidate_path`).
//!
//! ### 🔍 Debugging & Observability
//! - **Local Errors**: none
//! - **Telemetry Targets**: none declared
//! - **Witness Tests**: `test_shared_tool_cache_basic`, `test_shared_tool_cache_mtime_invalidation`, `test_shared_tool_cache_invalidate_path`
