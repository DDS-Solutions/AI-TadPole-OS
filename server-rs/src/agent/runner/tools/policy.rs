...
//! - `[Behavioral]` Tool mutation classification determines execution authorization boundaries (enforced_by: `test_mcp_underscore_server_mutation_classification`).
//!
//! ### 🔍 Debugging & Observability
//! - **Local Errors**: none
//! - **Telemetry Targets**: none declared
//! - **Witness Tests**: `test_mcp_underscore_server_mutation_classification`
...
pub(crate) fn resolve_required_permission(
    ...
    match name {
        ...
        | "list_file_symbols" | "get_symbol_body" | "query_symbol_graph" => {
