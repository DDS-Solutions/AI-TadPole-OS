...
//! - **Subsystem**: Sovereign Engine / Agent Runner / capability
//!
//! ### ⚠️ Invariants & Non-Negotiables
//! - `[Behavioral]` Capability tokens enforce least-privilege scoping and zero-trust revocation (enforced_by: `test_token_verify_allowed_files`, `test_token_revocation`).
//! - `[Behavioral]` Path containment strictly rejects prefix overlapping and directory traversal bypasses (enforced_by: `test_path_containment_bypass_rejected`, `test_target_traversal_rejected`).
//!
//! ### 🔍 Debugging & Observability
//! - **Local Errors**: none
//! - **Telemetry Targets**: `[capability]`
//! - **Witness Tests**: `test_token_verify_allowed_files`, `test_token_revocation`, `test_path_containment_bypass_rejected`, `test_target_traversal_rejected`
