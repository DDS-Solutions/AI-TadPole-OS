...
//! - `[Behavioral]` Capability permissions and tokens serialize deterministically for wire protocol stability (enforced_by: `test_token_serialization`, `test_working_memory_permission_granted`).
//!
//! ### 🔍 Debugging & Observability
//! - **Local Errors**: none
//! - **Telemetry Targets**: none declared
//! - **Witness Tests**: `test_token_serialization`, `test_working_memory_permission_granted`
