...
//! - `[Behavioral]` Path matching handles canonical globs while rejecting directory traversal and path prefix overlap (enforced_by: `test_canonical_path_matching`, `test_target_traversal_rejected`).
//!
//! ### 🔍 Debugging & Observability
//! - **Local Errors**: none
//! - **Telemetry Targets**: `[paths]`, `[capability]`
//! - **Witness Tests**: `test_canonical_path_matching`, `test_target_traversal_rejected`
