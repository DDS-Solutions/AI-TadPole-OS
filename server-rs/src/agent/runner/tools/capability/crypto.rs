...
//! - `[Behavioral]` HMAC cryptographic signatures prevent token tampering and detect invalid agent envelopes (enforced_by: `test_token_signature_tampering`, `test_a2a_envelope_sign_verify_and_tamper`).
//!
//! ### 🔍 Debugging & Observability
//! - **Local Errors**: none
//! - **Telemetry Targets**: `[crypto]`
//! - **Witness Tests**: `test_token_signature_tampering`, `test_a2a_envelope_sign_verify_and_tamper`
