...
//! - `[Behavioral]` Categorical handlers generated by define_categorical_handler dispatch to strongly-typed tool signatures (enforced_by: `test_manifest_matches_dispatcher`).
//!
