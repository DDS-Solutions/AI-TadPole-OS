...
//! - `[Behavioral]` Tool calls are pre-validated against hierarchy rules and authorized capabilities (enforced_by: `test_pre_validate_hierarchy_ceo_blocked`, `test_pre_validate_cbs_unauthorized_skill_blocked`).
//!
//! ### 🔍 Debugging & Observability
//! - **Local Errors**: none
//! - **Telemetry Targets**: none declared
//! - **Witness Tests**: `test_pre_validate_hierarchy_ceo_blocked`, `test_pre_validate_cbs_unauthorized_skill_blocked`
