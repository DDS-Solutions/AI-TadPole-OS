...
//! - `[Behavioral]` Tool manifest parity guarantees all core tools are registered with matching categorical handlers (enforced_by: `test_manifest_matches_dispatcher`).
//!
