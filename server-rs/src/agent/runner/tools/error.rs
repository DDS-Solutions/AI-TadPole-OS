...
impl From<ToolExecutionError> for AppError {
    fn from(err: ToolExecutionError) -> Self {
        match err {
            ...
            ToolExecutionError::SecurityBlocked(msg) | ToolExecutionError::HierarchyBlocked(msg) => {
                AppError::Forbidden(msg)
            }
            ToolExecutionError::Validation(msg) | ToolExecutionError::InvalidParameters { reason: msg, .. } => {
