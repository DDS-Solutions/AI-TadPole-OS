...
//! - **Subsystem**: Sovereign Engine / Agent Runner / refinement
//!
...
//! - **Witness Tests**: `test_refinement_no_error`, `test_refinement_spawn_subagent_hint`, `test_refinement_synthesized_skill_hint`
...
impl AgentRunner {
    ...
    pub(crate) fn handle_tool_failure_refinement(
        ...
        if is_synthesized {
            ...
            tracing::info!(
                "🧬 [Evolution] Injected refinement hint for synthesized skill: {}",
                fc.name
            );
