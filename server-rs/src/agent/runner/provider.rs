        ...
        loop {
                ...
                == crate::agent::types::ModelProvider::Ollama
            {
                if user_message.is_empty() {
                    480 // Give local Ollama synthesis/debrief calls up to 8 minutes for slow CPU/GPU offloads
                } else {
                    300 // Give standard local Ollama calls 300s (5 minutes) to avoid timeout during CPU prefill
                }
