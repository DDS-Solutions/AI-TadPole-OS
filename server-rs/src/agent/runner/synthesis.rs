...
//! 
//! ### AI Assist Note
//! **Prompt Synthesizer**: Assembles the agent's "consciousness" for each turn. 
//! Links identity, memory, codebase maps, and swarm findings. Features 
//! **Context Pruning** (TPM Protection) and **Hierarchy Enforcement** (CEO/COO protocols). 
//! Supports **Safe/Brainstorm Mode** (SEC-05) to disable all mutation tools.
//! 
//! ### 🔍 Debugging & Observability
//! - **Failure Path**: Tokenizer failure, context length exceeding TPM limits 
//!   (triggering truncation), or identity lookup cache miss.
