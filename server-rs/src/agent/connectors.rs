//! SME Connectors — External data ingestion and synchronization
//!
    ...
    for manifest in manifests {
        ...
        match connector.fetch_new_items(Some(manifest.last_sync_at)).await {
            Ok(items) => {
                ...
                {
                    tracing::warn!("⚠️ [IngestionWorker] Vector Memory feature is disabled. Skipping SME data ingestion for agent {}.", agent.id);
