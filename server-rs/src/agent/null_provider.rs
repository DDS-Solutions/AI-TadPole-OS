...
//! - **Subsystem**: Sovereign Engine / Agent Runner / null_provider
//!
...
pub enum NullReason {
    ...
    /// A required base URL is missing.
...
impl NullReason {
    pub fn as_str(&self) -> String {
        match self {
            ...
            NullReason::MissingBaseUrl { provider } => format!("missing_base_url ({})", provider),
