//! Google Gemini Provider - Native AI Integration
//!
//! @docs ARCHITECTURE:Agent
//!
//! ### AI Assist Note
//! **Hierarchy Detail**: Gemini requires messages to be structured as 
//! `contents[] -> parts[]`. This module handles the automated mapping 
//! from the engine's flat message structure. Supports native tools and 
//! multimodal blobs.
