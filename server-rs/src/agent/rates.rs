//! Neural Rates — Token pricing and financial ledger integration
//!
//! This module manages a centralized registry of AI model pricing and 
//! provides utilities for calculating USD costs based on token usage metrics.
//!
