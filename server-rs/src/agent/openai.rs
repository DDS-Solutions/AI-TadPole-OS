//! OpenAI Provider — GPT-4o and O1 integration via Chat Completion API
//!
//! @docs ARCHITECTURE:Agent
//!
//! Implements the `LlmProvider` trait for any OpenAI-spec endpoint. 
//! Optimized for cross-compatibility with secondary providers like Groq.
//!
//! @docs ARCHITECTURE:OpenAiProvider
//!
//! ### AI Assist Note
//! **Hallucination Recovery**: Features a regex-based engine to repair 
//! malformed tool calls from Llama models. Intercepts 400 errors to 
//! perform "in-flight" correction. Supports native tools where `model_id` 
//! enables `supports_native_tools()`.
