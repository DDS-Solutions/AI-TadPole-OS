//! LLM Output Parser — Structured data extraction and validation
//!
//! @docs ARCHITECTURE:Agent
//!
//! ### AI Assist Note
//! **Structural Preservation**: This engine preserves headers for CSV and 
//! markdown sections to maintain semantic context during chunking. 
//! Uses 25% overlap between chunks to ensure cohesive embedding coverage.
//!
//! # Supported Formats
