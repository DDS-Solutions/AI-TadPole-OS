//! Workflow Engine — Sequencing of multi-step autonomous tasks
//!
...
impl WorkflowExecutionState {
    pub fn new(name: String, content: &str) -> anyhow::Result<Self> {
...
fn parse_workflow_markdown(content: &str) -> anyhow::Result<Vec<WorkflowStep>> {
...
pub async fn load_workflow(
    ...
    name: &str,
) -> anyhow::Result<WorkflowExecutionState> {
    let path = base_dir
        .join("data")
        .join("workflows")
        .join(format!("{}.md", name));
