//! Groq Provider — High-speed inference and Llama-3 integration
//!
//! @docs ARCHITECTURE:Agent
//!
//! ### AI Assist Note
//! **Capabilities**: Specialized support for `transcribe()` using 
//! Whisper-large-v3. Inherits the regex-based `hallucination_recovery` 
//! engine. High rate limits make this ideal for rapid swarm turnarounds.
