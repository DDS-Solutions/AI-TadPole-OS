//! Skill Manifest — Registry of available tool schemas and documentation
//!
//! @docs ARCHITECTURE:Agent
//!
//! ### AI Assist Note
//! **Security Gate**: `Permission::ShellExecute` or `Permission::BudgetSpend` 
//! automatically force `requires_oversight = true` during manifest 
//! validation. This is a hard-coded safety boundary.
