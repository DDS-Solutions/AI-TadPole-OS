                    ...
                    match expected_type.as_str() {
                        ...
                        _ => {
                            ...
                            tracing::warn!(
                                ...
                                self.name, param_name, expected_type
                            );
                        }
                    }
                }
...
mod tests {
    ...
    fn test_validate_arguments() {
        ...
        assert!(res_missing.unwrap_err().to_string().contains("Missing required parameter"));
        ...
        assert!(res_type.unwrap_err().to_string().contains("expects type 'string'"));
    }
}
