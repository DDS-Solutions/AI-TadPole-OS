//! Request ID Middleware — Tracing and correlation
//!
//! Injects unique X-Request-ID headers into every request/response cycle, 
//! providing the backbone for system-wide trace correlation.
//!
