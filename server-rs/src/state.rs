...
impl AppState {
    ...
    pub async fn new() -> Self {
        ...
        let audio_cache = Arc::new(
            BunkerCache::new(audio_cache_path)
                .await
                .unwrap(),
        );
    ...
    pub fn broadcast_sys(&self, text: &str, severity: &str, mission_id: Option<String>) {
        ...
        let entry = LogEntry::new("System", &safe_text, severity, mission_id);
    ...
    pub async fn flush_all(&self) {
        tracing::info!("💾 [System] Flushing all volatile buffers and registries to persistence...");
