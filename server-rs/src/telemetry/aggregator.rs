...
//!
//! ### AI Assist Note
//! **Sliding Window**: Latency metrics are calculated over a fixed sliding 
//! window (`window_size`). High-frequency tool calls will cause older 
//! observations to be dropped rapidly. Metrics are not "Lifetime" averages.
