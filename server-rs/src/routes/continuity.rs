...
//!
//! ### AI Assist Note
//! **Job Scheduling**: Continuity jobs rely on standard `cron` expressions 
//! for execution timing. Agents should verify the `cron` syntax before 
//! creating/updating jobs to prevent invalid schedule errors. Workflows 
//! orchestrate multi-step agent tasks sequentially.
