//! Performance Benchmarks — Stress testing and metrics API
//!
//! Provides the endpoints for triggering agent and engine benchmarks, 
//! measuring latency, throughput, and token efficiency.
//!
