...
pub async fn clone_template_repository(
    ...
    let validated_target =
        crate::utils::security::validate_public_http_url(repository_url).await?;
...
pub(crate) mod tests {
    ...
    fn test_validate_git_ref_safe_and_unsafe() {
        ...
        assert_eq!(validate_git_ref("feature/templates_v2").unwrap(), "feature/templates_v2");
        assert_eq!(validate_git_ref("release-2026.08").unwrap(), "release-2026.08");
