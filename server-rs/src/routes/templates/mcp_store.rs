...
pub(crate) mod tests {
    ...
    fn test_merge_mcp_config_data_conflict_without_overwrite() {
        ...
        incoming_servers.insert(
            "stripe".to_string(),
            crate::agent::mcp::McpServerConfig::stdio("node", vec!["stripe.js".to_string()]),
        );
        ...
        existing_servers.insert(
            "stripe".to_string(),
            crate::agent::mcp::McpServerConfig::stdio("python", vec!["stripe.py".to_string()]),
        );
    ...
    async fn test_merge_and_save_mcp_config() {
        ...
        incoming_servers.insert(
            "github".to_string(),
            crate::agent::mcp::McpServerConfig::stdio("node", vec!["github.js".to_string()]),
        );
        let incoming = crate::agent::mcp::McpConfig {
            mcp_servers: incoming_servers,
        };
