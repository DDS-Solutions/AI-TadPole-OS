//! Route handler for the Environment Schema API.
//!
//! `GET /v1/env-schema` — Returns schema metadata (variable names, types,
//! descriptions, isSet booleans) without exposing any actual secret values.
//! Agents and the dashboard can query this to understand provider availability.
