//! Agent Skills — Discovery and metadata API
//!
//! Provides the unified endpoint for all agent capabilities: 
//! manifests, executable scripts, and multi-step workflows.
//!
...
pub async fn list_manifests(
    State(state): State<Arc<AppState>>,
) -> Result<Json<Vec<SkillManifest>>, AppError> {
    let mut manifests: Vec<SkillManifest> = state
        .registry
        .skill_registry
        .manifests
