//! API Pagination — Standardized response formatting
//!
//! Provides the reusable logic for windowed datasets and HATEOAS link 
//! generation across all collection endpoints.
//!
