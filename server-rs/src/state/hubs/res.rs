//! Resource Hub — Infrastructure components and shared mission context
//!
//! Manages thread-safe access to heavy infrastructure like the SQLite pool,
//! ONNX audio engines, and lazy-loaded vector memory stores.
//!
