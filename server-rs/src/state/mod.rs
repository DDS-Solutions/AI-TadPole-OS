...
impl AppState {
    ...
    pub async fn with_pool(pool: SqlitePool) -> Self {
        ...
        let security = Arc::new(SecurityHub {
            audit_trail: Arc::new(crate::security::audit::MerkleAuditTrail::mock_async().await.expect("Failed to initialize mock audit trail")),
    ...
    pub async fn new() -> Result<Self, AppError> {
        ...
        let security = Arc::new(SecurityHub {
            audit_trail: Arc::new(crate::security::audit::MerkleAuditTrail::new(pool.clone()).expect("Failed to initialize audit trail")),
            budget_guard: Arc::new(crate::security::metering::BudgetGuard::new(pool.clone())),
...
impl Default for AppState {
    ...
    fn default() -> Self {
        ...
        let security = Arc::new(SecurityHub {
            audit_trail: Arc::new(crate::security::audit::MerkleAuditTrail::mock().expect("Failed to initialize mock audit trail")),
        ...
        let resources = Arc::new(ResourceHub {
            ...
            code_graph: OnceCell::new(),
            symbol_graph: OnceCell::new(),
            obfuscation_salt: crate::intelligence::graph::derive_stable_salt(&std::path::PathBuf::from("data")),
            identity_context: OnceCell::new(),
            memory_context: OnceCell::new(),
            #[cfg(feature = "vector-memory")]
            swarm_vault: OnceCell::new(),
