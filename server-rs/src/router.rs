...
fn build_agent_routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/{id}", get(routes::agent::get_agent).put(routes::agent::update_agent))
...
fn build_system_routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/workspaces/status", get(routes::system::get_workspaces_status))
        .route("/workspaces/files", get(routes::system::get_workspace_files))
}
...
fn build_knowledge_routes() -> Router<Arc<AppState>> {
    #[cfg(feature = "vector-memory")]
    return Router::new()
        .route("/", post(routes::knowledge::write_knowledge).get(routes::knowledge::list_knowledge))
        .route("/search", get(routes::knowledge::search_knowledge))
        .route("/{id}/confirm", post(routes::knowledge::confirm_knowledge))
        .route("/{id}", axum::routing::delete(routes::knowledge::delete_knowledge));
    #[cfg(not(feature = "vector-memory"))]
