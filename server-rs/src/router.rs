...
fn build_memory_routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route(
            "/search/hybrid",
            get(routes::memory::hybrid_rag_search_handler),
        )
        .route(
            "/graph",
    ...
    Router::new()
        ...
        .route(
            ...
            get(routes::agent::get_agent)
                ...
                .delete(routes::agent::delete_agent)
...
fn build_intelligence_routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route(
            "/impacted-tests",
            get(routes::intelligence::get_impacted_tests),
        )
}
...
fn build_knowledge_routes() -> Router<Arc<AppState>> {
    ...
    return Router::new()
        .route(
            "/",
            post(routes::knowledge_fallback::write_knowledge_fallback)
                .get(routes::knowledge_fallback::list_knowledge_fallback),
        )
        .route(
            "/search",
            get(routes::knowledge_fallback::search_knowledge_fallback),
        )
        .route(
            "/{id}/confirm",
            post(routes::knowledge_fallback::confirm_knowledge_fallback),
        )
        .route(
            "/{id}/peers",
            get(routes::knowledge_fallback::get_knowledge_peers_fallback),
        )
        .route(
            "/{id}",
            axum::routing::delete(routes::knowledge_fallback::delete_knowledge_fallback),
        );
}
