//! Vault Adapter — Permanent mission-discovery and engine telemetry
//!
//! Orchestrates the writing of mission findings and persistent logs to the 
//! local vault directory, ensuring all paths are strictly canonicalized 
//! against directory traversal.
//!
//! @docs ARCHITECTURE:Networking
//!
//! ### AI Assist Note
//! **Timestamped Appends**: `append_to_file` does not perform a raw byte 
//! append. It automatically injects a horizontal rule (---) and a UTC 
//! timestamp before your content. Designed for human-readable discovery logs.
