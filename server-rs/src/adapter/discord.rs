//! Outbound notification adapter for Discord integration.
//!
//! This module enables the agent swarm to broadcast mission-critical updates
//! and system alerts to shared Discord channels via secure webhook integration.
