//! Discord Adapter — Outbound notification and system alerts
//!
//! Enables the agent swarm to broadcast mission-critical updates and system 
//! alerts to shared Discord channels via secure webhook integration.
//!
//! @docs ARCHITECTURE:Networking
//!
//! ### AI Assist Note
//! **Discord Rate Limits**: Discord webhooks are subject to global and 
//! channel-level rate limits. Agents should avoid rapid-fire notifications 
//! in tight loops, which will result in `429 Too Many Requests`.
