//! Filesystem Adapter — Secure workspace and data sandbox
//!
//! Provides a sandboxed interface for agents to interact with the local 
//! file system, enforcing strict path traversal protection (SEC-03).
//!
