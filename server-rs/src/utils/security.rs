...
//!
//! ### AI Assist Note
//! **Redaction Overlaps**: `redact_secrets` uses hierarchical regex patterns. 
//! A string like "Authorization: Bearer <key>" will be redacted multiple 
//! times (by header and token patterns), which is expected and safe.
