...
//!
//! ### AI Assist Note
//! **In-Memory Parsing**: All Tree-sitter operations are performed in-memory. 
//! For very large source files (>10MB), parsing may consume significant 
//! resources. Agents should favor targeted `CodeGraph` lookups over repeated 
//! raw file parsing.
