...
//!
//! ### AI Assist Note
//! **Scanning Boundaries**: `scan()` is hardcoded to `max_depth(3)` to prevent 
//! excessive resource usage during swarm discovery. Ignored paths are 
//! deterministic (`target`, `node_modules`).
