//! Architectural graph analysis and codebase structure mapping.
//!
//! Scans the local filesystem to build a hierarchical map of modules,
//! extracting descriptions from READMEs and tracking parent-child
//! relationships to visualize the overarching system architecture.
