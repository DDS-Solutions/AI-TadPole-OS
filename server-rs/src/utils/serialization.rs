//! Data serialization utilities with security and performance pruning.
//!
//! Provides wrappers for JSON values that automatically truncate large strings
//! and prevent recursive depth attacks, ensuring that logs and inter-agent
