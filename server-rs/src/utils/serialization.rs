...
//!
//! ### AI Assist Note
//! **Irreversible Truncation**: `prune_large_strings` and `sanitize_json` 
//! perform destructive truncation on large payloads (default 2KB). Once 
//! truncated, the original data cannot be recovered from the JSON value.
